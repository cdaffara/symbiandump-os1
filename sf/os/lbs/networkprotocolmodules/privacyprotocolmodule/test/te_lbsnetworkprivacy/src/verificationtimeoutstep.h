...
/**
 @file verificationtimeoutstep.h
*/
#if (!defined __VERIFICATIONTIMEOUT_STEP_H__)
#define __VERIFICATIONTIMEOUT_STEP_H__
...
_LIT(KVerificationTimeoutStep,"VerificationTimeoutStep");

class CNotifyVerificationTimeoutStep : public CTe_LbsNetworkPrivacySuiteStepBase,
                                       public MPosVerificationObserver
	{
public:
	CNotifyVerificationTimeoutStep();
	~CNotifyVerificationTimeoutStep();
...
private:
    ...
    */
    ...
    TInt iReqId;   	
   	CPosGSMPrivacyRequestInfo*iReqInfo;

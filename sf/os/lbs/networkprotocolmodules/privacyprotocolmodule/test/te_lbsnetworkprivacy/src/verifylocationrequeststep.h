...
/**
 @file verifylocationrequeststep.h
*/
#if (!defined __VERIFYLOCATIONREQUEST_STEP_H__)
#define __VERIFYLOCATIONREQUEST_STEP_H__
#include <test/testexecutestepbase.h>
#include "te_lbsnetworkprivacysuitestepbase.h"
#include <lbs/epos_mposverificationobserver.h>

_LIT(KVerifyLocationRequestStep,"VerifyLocationRequestStep");

class CVerifyLocationRequestStep : public CTe_LbsNetworkPrivacySuiteStepBase,
                                   public MPosVerificationObserver
	{
public:
	CVerifyLocationRequestStep();
	~CVerifyLocationRequestStep();
...
#endif //verifylocationrequeststep.h

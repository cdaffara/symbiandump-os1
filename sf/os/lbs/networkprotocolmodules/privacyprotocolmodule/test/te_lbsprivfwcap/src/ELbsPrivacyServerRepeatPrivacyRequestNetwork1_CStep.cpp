...
CELbsPrivacyServerRepeatPrivacyRequestNetwork1Step::CELbsPrivacyServerRepeatPrivacyRequestNetwork1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CELbsPrivacyServerRepeatPrivacyRequestNetwork1Step");
	...
	TCapability caplist1[] = {ECapabilityLocation,ECapabilityReadDeviceData,ECapabilityNetworkServices, ECapability_Limit};
...
*/
TInt CELbsPrivacyServerRepeatPrivacyRequestNetwork1Step::Exec_SendReceive()
	{

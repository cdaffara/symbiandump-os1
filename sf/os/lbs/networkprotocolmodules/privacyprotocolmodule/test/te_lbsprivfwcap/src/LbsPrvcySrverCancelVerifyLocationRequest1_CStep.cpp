...
CLbsPrvcySrverCancelVerifyLocationRequest1Step::CLbsPrvcySrverCancelVerifyLocationRequest1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CLbsPrvcySrverCancelVerifyLocationRequest1Step");
	...
	TCapability caplist1[] = {ECapabilityLocation,ECapabilityNetworkServices,ECapabilityReadDeviceData, ECapability_Limit};
...
*/
TInt CLbsPrvcySrverCancelVerifyLocationRequest1Step::Exec_SendReceive()
	{

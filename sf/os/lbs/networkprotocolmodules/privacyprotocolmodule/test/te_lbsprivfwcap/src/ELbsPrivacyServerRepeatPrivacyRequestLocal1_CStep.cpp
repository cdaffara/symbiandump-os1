...
CELbsPrivacyServerRepeatPrivacyRequestLocal1Step::CELbsPrivacyServerRepeatPrivacyRequestLocal1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CELbsPrivacyServerRepeatPrivacyRequestLocal1Step");
...
*/
TInt CELbsPrivacyServerRepeatPrivacyRequestLocal1Step::Exec_SendReceive()
	{

...
CELbsPrivacyServerVerifyLocation1Step::CELbsPrivacyServerVerifyLocation1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CELbsPrivacyServerVerifyLocation1Step");
...
*/
TInt CELbsPrivacyServerVerifyLocation1Step::Exec_SendReceive()
	{

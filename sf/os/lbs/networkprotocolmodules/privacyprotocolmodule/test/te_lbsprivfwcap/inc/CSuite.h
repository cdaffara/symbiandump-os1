...
//
// Description:
// TS_lbsprivfwcapServer.h
// This contains CTestlbsprivfwcapSuite 
// 
//

#if (!defined TS_lbsprivfwcap_SERVER_H_)
#define TS_lbsprivfwcap_SERVER_H_
...
const TUint KTestSecureServerMinorVersionNumber	= 0; 
const TUint KTestSecureServerBuildVersionNumber = 0;
...
class  CTestlbsprivfwcapServer : public CTestServer
{
public:
	static CTestlbsprivfwcapServer* NewL();
...
#endif /* TS_lbsprivfwcap_SERVER_H_ */

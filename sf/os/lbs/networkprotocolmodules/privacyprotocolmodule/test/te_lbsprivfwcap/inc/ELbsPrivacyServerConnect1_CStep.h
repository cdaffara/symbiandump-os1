...
#ifndef ELbsPrivacyServerConnect1_H_
#define ELbsPrivacyServerConnect1_H_
...
class CELbsPrivacyServerConnect1Step: public CCapabilityTestStep
	{
...
public:
	...
	CELbsPrivacyServerConnect1Step() ;

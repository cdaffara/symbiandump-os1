...
Cmolr15Step::~Cmolr15Step()
	{
	}

Cmolr15Step::Cmolr15Step()
	{
	SetTestStepName(Kmolr15Step);
	}
 ...
 */
TVerdict Cmolr15Step::doTestStepPreambleL()
...
*/
TVerdict Cmolr15Step::doTestStepL()
	{
	
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMOLR unexpected SUPL POS after SUPL START"));
	INFO_PRINTF1(_L("\t********************************************************************"));
 ...
 * Override of base class virtual
 */
TVerdict Cmolr15Step::doTestStepPostambleL()
	{
	delete iModule;

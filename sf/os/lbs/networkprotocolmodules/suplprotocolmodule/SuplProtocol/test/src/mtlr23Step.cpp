 ...
 */
TVerdict Cmtlr23Step::doTestStepPreambleL()
	{
...
*/
TVerdict Cmtlr23Step::doTestStepL()
	{
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMTLR - LBS requests Assistance Data before connection is established)"));
	INFO_PRINTF1(_L("\t********************************************************************"));
	...
	// ****************   Assistance data are requested by LBS before the connection is up  ************
	// **************************************************************************************************
 ...
 * Override of base class virtual
 */
TVerdict Cmtlr23Step::doTestStepPostambleL()
	{
	delete iModule;
...
*/
void Cmtlr23Step::OnSuplInitComplete(TLbsSuplPushChannel /*aChannel*/, TLbsSuplPushRequestId /*aReqId*/, TInt aError, TInt /*aReserved*/)
	{

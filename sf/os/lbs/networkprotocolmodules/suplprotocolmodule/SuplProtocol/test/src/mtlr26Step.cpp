 ...
 */
TVerdict Cmtlr26Step::doTestStepPreambleL()
	{
...
*/
TVerdict Cmtlr26Step::doTestStepL()
	{
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMTLR - LBS sends response with error code KPositionCalculationFutile)"));
	INFO_PRINTF1(_L("\t********************************************************************"));
	...
	// ****************   Location Response is sent by LBS with KPositionCalculationFutile  *************
	// **************************************************************************************************
	...
	iModule->RespondLocationRequest(iGatewayObserver->SessionIdValue(),KPositionCalculationFutile,mobilePosInfo);

	// Check Connection Manager receives a request to send a SUPL END
 ...
 * Override of base class virtual
 */
TVerdict Cmtlr26Step::doTestStepPostambleL()
	{
	delete iModule;
...
*/
void Cmtlr26Step::OnSuplInitComplete(TLbsSuplPushChannel /*aChannel*/, TLbsSuplPushRequestId /*aReqId*/, TInt aError, TInt /*aReserved*/)
	{

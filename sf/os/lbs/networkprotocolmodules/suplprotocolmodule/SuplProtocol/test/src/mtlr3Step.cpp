 ...
 */
TVerdict Cmtlr3Step::doTestStepPreambleL()
	{
...
*/
TVerdict Cmtlr3Step::doTestStepL()
	{
	INFO_PRINTF1(_L("\t********************************************************************"));
 ...
 * Override of base class virtual
 */
TVerdict Cmtlr3Step::doTestStepPostambleL()
	{
	delete iModule;
...
*/
void Cmtlr3Step::OnSuplInitComplete(TLbsSuplPushChannel /*aChannel*/, TLbsSuplPushRequestId /*aReqId*/, TInt aError, TInt /*aReserved*/)
	{

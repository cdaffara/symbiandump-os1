...
Cmolr14Step::~Cmolr14Step()
	{
	}

Cmolr14Step::Cmolr14Step()
	{
	SetTestStepName(Kmolr14Step);
	}
 ...
 */
TVerdict Cmolr14Step::doTestStepPreambleL()
...
a connection error indication after sending a SUPL POS INIT.

@return TVerdict test result code
*/
TVerdict Cmolr14Step::doTestStepL()
	{
	
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMOLR connection error after SUPL POS INIT"));
	INFO_PRINTF1(_L("\t********************************************************************"));
	...
	// Fake Connection Manager sending a Connection Error indication
 ...
 * Override of base class virtual
 */
TVerdict Cmolr14Step::doTestStepPostambleL()
	{
	delete iModule;

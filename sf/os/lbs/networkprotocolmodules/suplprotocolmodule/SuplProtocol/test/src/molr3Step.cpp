 ...
 */
TVerdict Cmolr3Step::doTestStepPreambleL()
...
Cancellation occurs after gateway receives location request following
a SUPL RESPONSE.

@return TVerdict test result code
*/
TVerdict Cmolr3Step::doTestStepL()

	{
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMOLR cancelled by LBS after SUPL RESPONSE"));
	INFO_PRINTF1(_L("\t********************************************************************"));
 ...
 * Override of base class virtual
 */
TVerdict Cmolr3Step::doTestStepPostambleL()
	{
	delete iModule;

 ...
 */
TVerdict Cmolr33Step::doTestStepPreambleL()
	{
...
*/
TVerdict Cmolr33Step::doTestStepL()
	{
	
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMOLR basic procedure followed - empty assistance data request"));
	INFO_PRINTF1(_L("\t********************************************************************"));
	...
	TLbsAsistanceDataGroup dataRequestMask1 = 0;
	options1.SetDataRequestMask(0);
	...
	// LBS Requests empty assistance data
	...
	// Check gateway receives unsolicited assistance data.
 ...
 * Override of base class virtual
 */
TVerdict Cmolr33Step::doTestStepPostambleL()
	{
	delete iModule;

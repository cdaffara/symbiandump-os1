 ...
 */
TVerdict Cmolr20Step::doTestStepPreambleL()
	{
...
a SUPL END with error code indication received during a positioning
session.

@return TVerdict test result code
*/
TVerdict Cmolr20Step::doTestStepL()
	{
	
 	
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMOLR SUPL END with error indication received after receiving SUPL POS"));
	INFO_PRINTF1(_L("\t********************************************************************"));
 ...
 * Override of base class virtual
 */
TVerdict Cmolr20Step::doTestStepPostambleL()
	{
	delete iModule;

...
# Description:
#
# createlbsprotocolmodulerep.mk
#
# makefile for creating the binary version of the LbsProtocolModule cenrep file
#

TARGET_REP_UID=10281D6F

TARGET=$(EPOCROOT)epoc32\winscw\c\private\10202BE9\$(TARGET_REP_UID).cre

SOURCE=$(EXTENSION_ROOT)$(TARGET_REP_UID).txt

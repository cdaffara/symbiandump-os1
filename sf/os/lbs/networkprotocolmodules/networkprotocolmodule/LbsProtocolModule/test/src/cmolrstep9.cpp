...
*/
TVerdict CMoLrStep9::doTestStepPreambleL()
	{
...
@return TVerdict test result code
*/
TVerdict CMoLrStep9::doTestStepL()
	{
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMOLR timeout waiting for network result"));
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("- START -"));
	// Initiate MO-LR
	TLbsNetSessionId sessionId1(TUid::Uid(0x87654321), 0x9999);
...
@return TVerdict test result code
*/
TVerdict CMoLrStep9::doTestStepPostambleL()
	{
	delete iModule;

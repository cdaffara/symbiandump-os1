...
*/
TVerdict CMoLrStep1::doTestStepPreambleL()
	{
...
@return TVerdict test result code
*/
TVerdict CMoLrStep1::doTestStepL()
	{
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tMOLR basic procedure followed"));
	INFO_PRINTF1(_L("\t********************************************************************"));
...
@return TVerdict test result code
*/
TVerdict CMoLrStep1::doTestStepPostambleL()
	{
	delete iModule;

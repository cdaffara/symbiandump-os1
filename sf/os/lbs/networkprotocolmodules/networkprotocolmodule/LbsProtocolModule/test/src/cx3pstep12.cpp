...
*/
TVerdict CX3pStep12::doTestStepPreambleL()
	{
...
/** Perform CX3pStep12 test step.
This test verifies that the Test Protocol Module correctly handles 
an X3P Self Locate sequence.

@return TVerdict test result code
*/
TVerdict CX3pStep12::doTestStepL()
	{
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tX3P Network returns error and no location"));
	INFO_PRINTF1(_L("\t********************************************************************"));
	...
	TPositionInfo* resultLoc = NULL;
	iNetworkObserver->ProcessFacilityLcsMoLrResultL(KErrGeneral, resultLoc);
...
@return TVerdict test result code
*/
TVerdict CX3pStep12::doTestStepPostambleL()
	{
	delete iModule;

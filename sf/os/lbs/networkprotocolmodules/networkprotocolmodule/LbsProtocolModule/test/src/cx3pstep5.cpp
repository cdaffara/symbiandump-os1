...
const TUint KX3pSessionId = 0x105;
...
*/
TVerdict CX3pStep5::doTestStepPreambleL()
	{
...
@return TVerdict test result code
*/
TVerdict CX3pStep5::doTestStepL()
	{
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tX3P with cancel sent before loc request received"));
	INFO_PRINTF1(_L("\t********************************************************************"));
...
@return TVerdict test result code
*/
TVerdict CX3pStep5::doTestStepPostambleL()
	{
	delete iModule;

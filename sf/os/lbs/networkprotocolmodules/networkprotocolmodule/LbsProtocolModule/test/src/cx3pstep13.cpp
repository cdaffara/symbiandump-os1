...
_LIT(KX3pDestination, "x3pstep13@there.com");
const TUint KX3pSessionId = 0x101;
const TInt  KX3pPriority = 0x01;

/** Destructor
*/
CX3pStep13::~CX3pStep13()
	{
	}
...
*/
TVerdict CX3pStep13::doTestStepPreambleL()
	{
...
/** Perform CX3pStep13 test step.
This test verifies that the Test Protocol Module correctly handles 
an X3P Self Locate sequence.

@return TVerdict test result code
*/
TVerdict CX3pStep13::doTestStepL()
	{
	INFO_PRINTF1(_L("\t********************************************************************"));
	INFO_PRINTF1(_L("\tX3P cancel after sending location response to network"));
	INFO_PRINTF1(_L("\t********************************************************************"));
...
@return TVerdict test result code
*/
TVerdict CX3pStep13::doTestStepPostambleL()
	{
	delete iModule;

...
/**
 @file RepeatGetAssistanceDataStep.cpp
*/
...
CRepeatGetAssistanceDataStep::~CRepeatGetAssistanceDataStep()
/**
 * Destructor
 */
	{
...
CRepeatGetAssistanceDataStep::CRepeatGetAssistanceDataStep(CTe_lbssupltestmoduleSuite* aOwningServer): CTe_lbssupltestmoduleSuiteStepBase(aOwningServer)
	{
	// **MUST** call SetTestStepName in the constructor as the controlling
	// framework uses the test step name immediately following construction to set
	// up the step's unique logging ID.
	SetTestStepName(KRepeatGetAssistanceDataStep);
	}

TVerdict CRepeatGetAssistanceDataStep::doTestStepPreambleL()
/**
 * @return - TVerdict code
 * Override of base class virtual
 */
	{
	INFO_PRINTF1(_L("Please delete this line or modify it. I am in Test Step Preamble in Class CRepeatGetAssistanceDataStep"));
...
TVerdict CRepeatGetAssistanceDataStep::doTestStepL()
/**
 * @return - TVerdict code
 ...
 */
	...
	if (TestStepResult()==EPass)
		{
		//If the plug-in loaded fine, try to retrieve assistance data 4 times
		//
		TInt nbAssistanceDataRequests = 4;
		CAssistanceDataRetriever* dataRetriever = CAssistanceDataRetriever::NewL(*this, nbAssistanceDataRequests);
...
void CRepeatGetAssistanceDataStep::notifyResult(const TInt& aResult)
{
	if (aResult != KErrNone)
	{
	   ERR_PRINTF1(_L("Could not get Assistance Data"));
       SetTestStepResult(EFail);
	}
}

TVerdict CRepeatGetAssistanceDataStep::doTestStepPostambleL()
/**
 * @return - TVerdict code
 * Override of base class virtual
 */

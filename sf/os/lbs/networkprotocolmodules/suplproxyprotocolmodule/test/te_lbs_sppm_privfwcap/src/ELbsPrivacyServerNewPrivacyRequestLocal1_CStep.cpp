...
CELbsPrivacyServerNewPrivacyRequestLocal1Step::CELbsPrivacyServerNewPrivacyRequestLocal1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CELbsPrivacyServerNewPrivacyRequestLocal1Step");
...
*/
TInt CELbsPrivacyServerNewPrivacyRequestLocal1Step::Exec_SendReceive()
	{

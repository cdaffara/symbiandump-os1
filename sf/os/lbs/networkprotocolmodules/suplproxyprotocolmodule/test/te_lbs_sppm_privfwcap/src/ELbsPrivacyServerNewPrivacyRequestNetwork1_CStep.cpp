...
CELbsPrivacyServerNewPrivacyRequestNetwork1Step::CELbsPrivacyServerNewPrivacyRequestNetwork1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CELbsPrivacyServerNewPrivacyRequestNetwork1Step");
...
*/
TInt CELbsPrivacyServerNewPrivacyRequestNetwork1Step::Exec_SendReceive()
	{

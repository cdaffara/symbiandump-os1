...
CLbsPrvacyServerNotifyVerificationTimeout1Step::CLbsPrvacyServerNotifyVerificationTimeout1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CLbsPrvacyServerNotifyVerificationTimeout1Step");
...
*/
TInt CLbsPrvacyServerNotifyVerificationTimeout1Step::Exec_SendReceive()
	{

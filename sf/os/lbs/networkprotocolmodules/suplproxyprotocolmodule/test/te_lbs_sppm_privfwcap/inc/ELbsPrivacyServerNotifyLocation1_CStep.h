...
#ifndef ELbsPrivacyServerNotifyLocation1_H_
#define ELbsPrivacyServerNotifyLocation1_H_
...
class CELbsPrivacyServerNotifyLocation1Step: public CCapabilityTestStep
	{
...
public:
	...
	CELbsPrivacyServerNotifyLocation1Step() ;

...
#ifndef ELbsPrivacyServerCompleteRequest1_H_
#define ELbsPrivacyServerCompleteRequest1_H_
...
class CELbsPrivacyServerCompleteRequest1Step: public CCapabilityTestStep
	{
...
public:
	...
	CELbsPrivacyServerCompleteRequest1Step() ;

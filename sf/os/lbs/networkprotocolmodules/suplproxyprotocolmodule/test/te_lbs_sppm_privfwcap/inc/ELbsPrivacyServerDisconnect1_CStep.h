...
#ifndef ELbsPrivacyServerDisconnect1_H_
#define ELbsPrivacyServerDisconnect1_H_
...
class CELbsPrivacyServerDisconnect1Step: public CCapabilityTestStep
	{
...
public:
	...
	CELbsPrivacyServerDisconnect1Step() ;

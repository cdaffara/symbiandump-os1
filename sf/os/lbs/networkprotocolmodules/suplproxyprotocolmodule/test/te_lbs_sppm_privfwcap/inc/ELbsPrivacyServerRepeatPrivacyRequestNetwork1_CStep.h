...
#ifndef ELbsPrivacyServerRepeatPrivacyRequestNetwork1_H_
#define ELbsPrivacyServerRepeatPrivacyRequestNetwork1_H_
...
class CELbsPrivacyServerRepeatPrivacyRequestNetwork1Step: public CCapabilityTestStep
	{
...
public:
	...
	TVersion Version()
	{
		return TVersion(KTestSecureServerMajorVersionNumber, KTestSecureServerMinorVersionNumber, KTestSecureServerBuildVersionNumber);
	}	
	
	
	//Constructor called from the respective Suite.cpp from their "AddTestStep" function
	CELbsPrivacyServerRepeatPrivacyRequestNetwork1Step() ;

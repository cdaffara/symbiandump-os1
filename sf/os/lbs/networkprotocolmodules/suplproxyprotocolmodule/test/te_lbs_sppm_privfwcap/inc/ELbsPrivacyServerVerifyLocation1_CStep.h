...
#ifndef ELbsPrivacyServerVerifyLocation1_H_
#define ELbsPrivacyServerVerifyLocation1_H_
...
class CELbsPrivacyServerVerifyLocation1Step: public CCapabilityTestStep
	{
...
public:
	...
	CELbsPrivacyServerVerifyLocation1Step() ;

...
#include "extgpspsy1.h"
#include "extgpspsy1.hrh"


const TInt KSecondToMicro = 1000000;

const TImplementationProxy KFactoryPtr = {{KExtGpsPsy1ImplUid}, (TProxyNewLPtr)CExtGpsPsy1::NewL};
...
CExtGpsPsy1* CExtGpsPsy1::NewL(TAny* aConstructionParameters)
    {
    CExtGpsPsy1* self = new(ELeave) CExtGpsPsy1;
...
void CExtGpsPsy1::ConstructL(TAny* aConstructionParameters)
{
...
void CExtGpsPsy1::NotifyPositionUpdate(
...
void CExtGpsPsy1::ConfigPsyL(const HPositionGenericInfo& aGenInfo)
    {
    TInt32 configUid;
...
TInt CExtGpsPsy1::TimerCallback(TAny* aAny)
    {
    reinterpret_cast<CExtGpsPsy1*>(aAny)->TimerCompleted();
    return KErrNone;
    }
        
void CExtGpsPsy1::TimerCompleted()
    {
...
void CExtGpsPsy1::StartTimerIfNeeded()
    {
...
void CExtGpsPsy1::CompleteRequestByDefault()
    {
    if(!iRequestStatus)
        {
        return;
...
void CExtGpsPsy1::CompleteRequest(TInt aCompletionCode)
    {
    if(iRequestStatus)
        {
...
void CExtGpsPsy1::CancelNotifyPositionUpdate()
{
    if(iRequestStatus &&
...
TBool CExtGpsPsy1::TrackingOverridden() const
{
    return ETrue;
}

void CExtGpsPsy1::StartTrackingL(const TTimeIntervalMicroSeconds& /*aInterval*/)
{
}

void CExtGpsPsy1::StopTracking()
{
}

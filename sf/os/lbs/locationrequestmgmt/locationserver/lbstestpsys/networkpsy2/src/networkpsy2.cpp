...
#include "networkpsy2.h"
#include "networkpsy2.hrh"


const TInt KSecondToMicro = 1000000;

const TImplementationProxy KFactoryPtr = {{KNetworkPsy2ImplUid}, (TProxyNewLPtr)CNetworkPsy2::NewL};
...
CNetworkPsy2* CNetworkPsy2::NewL(TAny* aConstructionParameters)
    {
    CNetworkPsy2* self = new(ELeave) CNetworkPsy2;
...
void CNetworkPsy2::ConstructL(TAny* aConstructionParameters)
{
...
TInt CNetworkPsy2::TimerCallback(TAny* aAny)
    {
    reinterpret_cast<CNetworkPsy2*>(aAny)->TimerCompleted();
    return KErrNone;
    }
...
void CNetworkPsy2::StartTimerIfNeeded()
    {
...
void CNetworkPsy2::CompleteRequest(TInt aCompletionCode)
    {
    if(iRequestStatus)
        {
...
TBool CNetworkPsy2::TrackingOverridden() const
{
    return ETrue;
}

void CNetworkPsy2::StartTrackingL(const TTimeIntervalMicroSeconds& /*aInterval*/)
{
}

void CNetworkPsy2::StopTracking()
{
}

...
#ifndef __CT_LBS_TESTPSY21POSITIONER_H__
#define __CT_LBS_TESTPSY21POSITIONER_H__
...
*
*/
class CT_LbsTestPsy21Positioner : public CPositioner
    {
   public:  // Constructors and destructor
        ...
        */
        static CT_LbsTestPsy21Positioner* NewL(TAny* aConstructionParameters);

        /**
        * Two-phased constructor.
        */
        static CT_LbsTestPsy21Positioner* NewLC(TAny* aConstructionParameters);

        /**
        * Destructor.
        */
        ~CT_LbsTestPsy21Positioner();
    ...
    private:
        ...
        */
        ...
        CT_LbsTestPsy21Positioner( const CT_LbsTestPsy21Positioner& );
        // Prohibit assigment operator
        CT_LbsTestPsy21Positioner& operator= ( const CT_LbsTestPsy21Positioner& );
...
#endif      // __CT_LBS_TESTPSY21POSITIONER_H__

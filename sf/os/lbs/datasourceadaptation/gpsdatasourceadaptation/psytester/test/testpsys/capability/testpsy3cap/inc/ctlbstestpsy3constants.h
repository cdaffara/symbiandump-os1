...
#ifndef __CT_LBS_TESTPSY3CONSTANTS_H__
#define __CT_LBS_TESTPSY3CONSTANTS_H__
...
_LIT8(KNMEASentencesStart, "$GPGSV,*71$GPGSV,3,2,12,24,32,051,,22,21,292,,01,20,315,,14,20,321,*71");
const TUint8 KNMEASentences1 = 1;
_LIT8(KNMEASentencesSecond, "$GPGSV,3,2,12,24,32,051,,22,21,292,,01,20,315,,14,20,321,*71");
...
#endif      // __CT_LBS_TESTPSY3CONSTANTS_H__

...
//
// Description:
// @file ctlbsconflictstepx3pmenumenu.h
// This contains the header file for Location Data Source Tests
// 
//

#ifndef __CT_LBS_CONFLICT_STEP_X3PMENUMENU_H__
#define __CT_LBS_CONFLICT_STEP_X3PMENUMENU_H__
...
// Literals used
_LIT(KLbsConflictStep_X3PMenuMenu, "LbsConflictStep_X3PMenuMenu");


class CT_LbsConflictStep_X3PMenuMenu :	public	CT_LbsConflictStep,
										public	MT_LbsDoX3PObserver
	{
public:
	~CT_LbsConflictStep_X3PMenuMenu();

	static CT_LbsConflictStep_X3PMenuMenu* New(CT_LbsConflictServer& aParent);
...
private:
	CT_LbsConflictStep_X3PMenuMenu(CT_LbsConflictServer& aParent);
	void ConstructL();		
	...
	*/
	...
	CT_LbsDoX3P* iDoX3PMenu2;
	};

#endif //__CT_LBS_CONFLICT_STEP_X3PMENUMENU_H__

...
//
// Description:
// @file ctlbsconflictstepselflocatex3ppush.h
// This contains the header file for Location Data Source Tests
// 
//

#ifndef __CT_LBS_CONFLICT_STEP_SELFLOCATEPUSH_H__
#define __CT_LBS_CONFLICT_STEP_SELFLOCATEPUSH_H__
...
_LIT(KLbsConflictStepselflocatex3ppush, "LbsConflictStep_selflocatex3ppush");
...
class CT_LbsConflictStep_selflocatex3ppush :	public	CT_LbsConflictStep,
...
//								public	MLbsPrivacyObserver
	{
public:
	~CT_LbsConflictStep_selflocatex3ppush();

	static CT_LbsConflictStep_selflocatex3ppush* New(CT_LbsConflictServer& aParent);
...
private:
	CT_LbsConflictStep_selflocatex3ppush(CT_LbsConflictServer& aParent);
	void ConstructL();		
...
#endif //__CT_LBS_CONFLICT_STEP_SELFLOCATEPUSH_H__

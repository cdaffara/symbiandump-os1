...
//
// Description:
// @file ctlbsconflictstepx3ptimerpush.h
// This contains the header file for Location Data Source Tests
// 
//

#ifndef __CT_LBS_CONFLICT_STEP_X3PTIMERPUSH_H__
#define __CT_LBS_CONFLICT_STEP_X3PTIMERPUSH_H__
...
// Literals used
_LIT(KLbsConflictStep_X3PTimerPush, "LbsConflictStep_X3PTimerPush");


class CT_LbsConflictStep_X3PTimerPush :	public	CT_LbsConflictStep,
										public	MT_LbsDoX3PObserver
	{
public:
	~CT_LbsConflictStep_X3PTimerPush();

	static CT_LbsConflictStep_X3PTimerPush* New(CT_LbsConflictServer& aParent);
...
private:
	CT_LbsConflictStep_X3PTimerPush(CT_LbsConflictServer& aParent);
	void ConstructL();		
	...
	enum {	EReqX3PTimer = CT_LbsConflictStep::ELast,
			EReqX3PPush, EReqX3PTimer2};

	/** Active object wrapper to allow X3Ps.
	*/
	CT_LbsDoX3P* iDoX3PTimer;
	CT_LbsDoX3P* iDoX3PPush;
	};

#endif //__CT_LBS_CONFLICT_STEP_X3PTIMERPUSH_H__

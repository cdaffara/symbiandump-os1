...
#ifndef __CT_LBS_CONFLICT_STEP_EXAMPLE_H__
#define __CT_LBS_CONFLICT_STEP_EXAMPLE_H__
...
// Literals used
_LIT(KLbsConflictStep_Example, "LbsConflictStep_Example");
...
class CT_LbsConflictStep_Example :	public	CT_LbsConflictStep,
...
//								public	MLbsPrivacyObserver
	{
public:
	~CT_LbsConflictStep_Example();

	static CT_LbsConflictStep_Example* New(CT_LbsConflictServer& aParent);
...
private:
	CT_LbsConflictStep_Example(CT_LbsConflictServer& aParent);
	void ConstructL();		
...
#endif //__CT_LBS_CONFLICT_STEP_EXAMPLE_H__

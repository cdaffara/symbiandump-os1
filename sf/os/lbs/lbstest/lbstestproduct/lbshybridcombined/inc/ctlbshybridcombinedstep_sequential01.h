...
#ifndef __CT_LBS_HYBRIDCOMBINED_SEQUENTIAL01_H__
#define __CT_LBS_HYBRIDCOMBINED_SEQUENTIAL01_H__
...
// Literals used
_LIT(KLbsHybridCombinedStep_Sequential01, "LbsHybridCombinedStep_Sequential01");

class CT_LbsHybridCombinedStep_Sequential01 :	public	CT_LbsHybridCombinedStep_Base, public MPosServerObserver, public MLbsPrivacyObserver
	{
public:
	~CT_LbsHybridCombinedStep_Sequential01();

	static CT_LbsHybridCombinedStep_Sequential01* New(CT_LbsHybridCombinedServer& aParent);
...
protected:
	CT_LbsHybridCombinedStep_Sequential01(CT_LbsHybridCombinedServer& aParent);
	void ConstructL();

	};

#endif //__CT_LBS_HYBRIDCOMBINED_SEQUENTIAL01_H__

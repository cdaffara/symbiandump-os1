...
#ifndef __CT_LBS_HYBRIDCOMBINED_CONCURRENT02_H__
#define __CT_LBS_HYBRIDCOMBINED_CONCURRENT02_H__
...
// Literals used
_LIT(KLbsHybridCombinedStep_Concurrent02, "LbsHybridCombinedStep_Concurrent02");

class CT_LbsHybridCombinedStep_Concurrent02 :	public	CT_LbsHybridCombinedStep_Base, public MPosServerObserver, public MLbsPrivacyObserver
	{
public:
	~CT_LbsHybridCombinedStep_Concurrent02();

	static CT_LbsHybridCombinedStep_Concurrent02* New(CT_LbsHybridCombinedServer& aParent);
...
protected:
	CT_LbsHybridCombinedStep_Concurrent02(CT_LbsHybridCombinedServer& aParent);
	void ConstructL();
	};

#endif //__CT_LBS_HYBRIDCOMBINED_CONCURRENT02_H__

...
#ifndef __CT_LBS_HYBRIDCOMBINED_TRACKING02_H__
#define __CT_LBS_HYBRIDCOMBINED_TRACKING02_H__
...
// Literals used
_LIT(KLbsHybridCombinedStep_Tracking02, "LbsHybridCombinedStep_Tracking02");

class CT_LbsHybridCombinedStep_Tracking02 :	public	CT_LbsHybridCombinedStep_Base, public MPosServerObserver, public MLbsPrivacyObserver
	{
public:
	~CT_LbsHybridCombinedStep_Tracking02();

	static CT_LbsHybridCombinedStep_Tracking02* New(CT_LbsHybridCombinedServer& aParent);
...
protected:
	CT_LbsHybridCombinedStep_Tracking02(CT_LbsHybridCombinedServer& aParent);
	void ConstructL();
...
#endif //__CT_LBS_HYBRIDCOMBINED_TRACKING02_H__

...
#ifndef __CT_LBS_EXT_PTB_CANCEL_H__
#define __CT_LBS_EXT_PTB_CANCEL_H__
...
// Literals used
_LIT(KLbsExtPtbMtlrCancel,"KLbsExtPtbMtlrCancel");

class CT_LbsExtPtbMTLRCancel: public CT_LbsExtendedMTLRStep, public MLbsPrivacyObserver
{
public:
    static CT_LbsExtPtbMTLRCancel* New(CT_LbsExtendedMTLRServer& aParent);
    enum TVerdict doTestStepL();
    ~CT_LbsExtPtbMTLRCancel();
...
protected:
    CT_LbsExtPtbMTLRCancel(CT_LbsExtendedMTLRServer& aParent);
    void ConstructL();
private:
...
#endif //__CT_LBS_EXT_PTB_CANCEL_H__

...
#ifndef __CT_LBS_EXTENDED_CANCEL_H__
#define __CT_LBS_EXTENDED_CANCEL_H__
...
// jcm  temp botch #include "lbsnetprotocolproxy.h"


// Literals used
_LIT(KLbsExtendedMtlrCancel,"KLbsExtendedMtlrCancel");

class CT_LbsExtendedMTLRCancel: public CT_LbsExtendedMTLRStep, public MLbsPrivacyObserver
{
public:
    static CT_LbsExtendedMTLRCancel* New(CT_LbsExtendedMTLRServer& aParent);
    enum TVerdict doTestStepL();
    ~CT_LbsExtendedMTLRCancel();
...
protected:
    CT_LbsExtendedMTLRCancel(CT_LbsExtendedMTLRServer& aParent);
    void ConstructL();
private:
...
#endif //__CT_LBS_EXTENDED_CANCEL_H__

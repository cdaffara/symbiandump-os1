...
// This contains the header file for LBS Extended PM  MTLR Test Step Base
// 
//

#ifndef __CT_LBS_EXTENDED_MTLR_STEP_H__
#define __CT_LBS_EXTENDED_MTLR_STEP_H__
...
const TUid KRequestUid = {0x10285AB7}; // the extended protcol module!
/** Delta timout value used in all tests */
const TInt KDelta = 2.0 * 1000 * 1000;	//2 seconds

class CT_LbsExtendedMTLRStep : public CTestStep, MT_AgpsModuleEventHandler
{

public:
	virtual ~CT_LbsExtendedMTLRStep();
	
	virtual TVerdict doTestStepPreambleL();
	virtual TVerdict doTestStepPostambleL();

protected:
	CT_LbsExtendedMTLRStep(CT_LbsExtendedMTLRServer& aParent);
	void ConstructL();
...
protected:
	CT_LbsExtendedMTLRServer& iParent;
};
...
#endif // __CT_LBS_EXTENDED_MTLR_STEP_H__

...
Static Constructor
*/
CT_LbsExtHybridMTLRCancel* CT_LbsExtHybridMTLRCancel::New(CT_LbsExtendedMTLRServer& aParent)
	{
	// Note that we do not use ELeave.
	// This means that having insufficient memory will return NULL;
	CT_LbsExtHybridMTLRCancel* testStep = new CT_LbsExtHybridMTLRCancel(aParent);
	if (testStep)
		{
		TInt err = KErrNone;
 ...
 * Constructor
 */
CT_LbsExtHybridMTLRCancel::CT_LbsExtHybridMTLRCancel(CT_LbsExtendedMTLRServer& aParent) : CT_LbsExtendedMTLRStep(aParent)
	{
	SetTestStepName(KLbsExtHybridMtlrCancel);
...
void CT_LbsExtHybridMTLRCancel::ConstructL()
	{
 ...
 * Destructor
 */
CT_LbsExtHybridMTLRCancel::~CT_LbsExtHybridMTLRCancel()
	{
	delete iController;
	delete iProxy;
	}
...
TVerdict CT_LbsExtHybridMTLRCancel::doTestStepL()
	{
...
void CT_LbsExtHybridMTLRCancel::ProcessNetworkLocationRequest(TUint aRequestId, const TLbsExternalRequestInfo& /*aRequestInfo*/, const TNotificationType& /*aNotificationType*/)
	{
	INFO_PRINTF1(_L("&gt;&gt;CT_LbsExtHybridMTLRCancel::ProcessNetworkLocationRequest()"));
...
void CT_LbsExtHybridMTLRCancel::ProcessNetworkPositionUpdate(TUint /*aRequestId*/, const TPositionInfo& aPosInfo)
	{
	if(iState==EPrivacyCheckOk)
			...
			INFO_PRINTF1(_L("&gt;&gt;CT_LbsExtHybridMTLRCancel::ProcessNetworkPositionUpdate(RefPosition)"));
			}
		ReturnToTestStep();
	}

void CT_LbsExtHybridMTLRCancel::ProcessRequestComplete(TUint /*aRequestId*/, TInt aReason)
	{
...
void CT_LbsExtHybridMTLRCancel::InitiateCancelMTLR(TUint aRequestId)
	{
	INFO_PRINTF1(_L("&gt;&gt;CT_LbsExtHybridMTLRCancel::initiateCancelMTLR()"));

...
//
// Description:
// @file ctlbsprivfwstepverifyreturnerrors.h
// This contains the header file for an LBS privacy handler test
// 
//

#ifndef __CT_LBS_PRIVFW_STEP_VERIFYRNERRORS_H__
#define __CT_LBS_PRIVFW_STEP_VERIFYRNERRORS_H__
...
_LIT(KLbsPrivFwStep_VerifyReturnErrors, "KLbsPrivFwStep_VerifyReturnErrors");

class CT_LbsPrivFwStepVerifyReturnErrors : public CT_LbsPrivFwStepBase
{

public:
	virtual ~CT_LbsPrivFwStepVerifyReturnErrors();
	static CT_LbsPrivFwStepVerifyReturnErrors* New(CT_LbsPrivFwServer& aParent);
...
protected:
	...
	CT_LbsPrivFwStepVerifyReturnErrors(CT_LbsPrivFwServer& aParent);
...
#endif // __CT_LBS_PRIVFW_STEP_VERIFYRNERRORS_H__

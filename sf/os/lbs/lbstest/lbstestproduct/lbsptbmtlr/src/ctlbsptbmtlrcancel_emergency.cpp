...
Static Constructor
*/
CT_LbsPTBMTLRCancelEmergency* CT_LbsPTBMTLRCancelEmergency::New(CT_LbsPTBMTLRServer& aParent)
	{
	// Note that we do not use ELeave.
	// This means that having insufficient memory will return NULL;
	CT_LbsPTBMTLRCancelEmergency* testStep = new CT_LbsPTBMTLRCancelEmergency(aParent);
	if (testStep)
		{
		TInt err = KErrNone;
 ...
 * Constructor
 */
CT_LbsPTBMTLRCancelEmergency::CT_LbsPTBMTLRCancelEmergency(CT_LbsPTBMTLRServer& aParent) : CT_LbsPTBMTLRStep(aParent)
	{
	SetTestStepName(KLbsPTBMTLRCancelEmergency);
...
void CT_LbsPTBMTLRCancelEmergency::ConstructL()
	{
 ...
 * Destructor
 */
CT_LbsPTBMTLRCancelEmergency::~CT_LbsPTBMTLRCancelEmergency()
	{
	delete iController;
	delete iProxy;
	}
...
TVerdict CT_LbsPTBMTLRCancelEmergency::doTestStepL()
	{
	INFO_PRINTF1(_L("&gt;&gt;CT_LbsPTBMTLRCancelEmergency::doTestStepL()"));
...
void CT_LbsPTBMTLRCancelEmergency::ProcessNetworkLocationRequest(TUint aRequestId, const TLbsExternalRequestInfo& /*aRequestInfo*/, const TNotificationType& /*aNotificationType*/)
	{
...
void CT_LbsPTBMTLRCancelEmergency::ProcessNetworkPositionUpdate(TUint /*aRequestId*/, const TPositionInfo& aPosInfo)
	{
	if(iState==EPrivacyCheckOk)
		...
		TPosition getPos;
		aPosInfo.GetPosition(getPos);
		if(isAGPSposition && getPos.Latitude()==49.2 && getPos.HorizontalAccuracy()==2.0 && getPos.VerticalAccuracy()==3) 		
			{
...
void CT_LbsPTBMTLRCancelEmergency::ProcessRequestComplete(TUint /*aRequestId*/, TInt aReason)
	{
...
void CT_LbsPTBMTLRCancelEmergency::InitiateCancelMTLR(TUint aRequestId)
	{

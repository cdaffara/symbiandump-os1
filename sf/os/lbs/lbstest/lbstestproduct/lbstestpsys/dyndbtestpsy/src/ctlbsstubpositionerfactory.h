...
#ifndef __CT_LBS_STUB_POSITIONER_FACTORY_H__
#define __CT_LBS_STUB_POSITIONER_FACTORY_H__
...
*/
class CT_LbsStubPositionerFactory :public CPosSubSessionFactoryBase
    {
    public:  // Constructors and destructor
        ...
        */
        CT_LbsStubPositionerFactory();

        /**
        * Destructor.
        */
        virtual ~CT_LbsStubPositionerFactory();
    ...
    private:
        ...
        CT_LbsStubPositionerFactory( const CT_LbsStubPositionerFactory& );
        // Prohibit assigment operator
        CT_LbsStubPositionerFactory& operator= ( const CT_LbsStubPositionerFactory& );
    };

#endif      // __CT_LBS_STUB_POSITIONER_FACTORY_H__   

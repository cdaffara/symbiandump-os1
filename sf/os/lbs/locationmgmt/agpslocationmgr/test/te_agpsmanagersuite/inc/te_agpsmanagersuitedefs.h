...
#include "lbsagpsngmsgs.h" // for TLbsNetSessionCompleteAgpsMsg
...
#include "lbsnrhngmsgs.h"	// for TLbsNetSessionIdInt
const TLbsNetSessionIdInt KDummySessionIdInt;
const TLbsNetSessionCompleteAgpsMsg KSessionCompleteKErrNone(KDummySessionIdInt, KErrNone);
#endif

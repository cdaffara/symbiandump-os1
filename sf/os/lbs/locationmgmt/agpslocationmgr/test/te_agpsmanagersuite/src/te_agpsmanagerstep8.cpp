...
CTe_AgpsManagerStep8::~CTe_AgpsManagerStep8()
	{
	}

CTe_AgpsManagerStep8::CTe_AgpsManagerStep8()
	{
	SetTestStepName(KAgpsManagerStep8);
	}

TVerdict CTe_AgpsManagerStep8::doTestStepPreambleL()
	{
...
//
// Valid Positioning Method from the NRH in TBorTA H/W.
...
//
TVerdict CTe_AgpsManagerStep8::doTestStepL()
	{
 	if (TestStepResult()==EPass)
		...
		__ASSERT_ALWAYS(KErrNone == iCapabilitiesProperty.Set(KManagerTestSuiteUid,
															  ...
															  (TPositionModuleInfoExtended::EDeviceGpsModeTerminalBased | TPositionModuleInfoExtended::EDeviceGpsModeTerminalAssisted)),
															  User::Invariant());
...
TVerdict CTe_AgpsManagerStep8::doTestStepPostambleL()
	{

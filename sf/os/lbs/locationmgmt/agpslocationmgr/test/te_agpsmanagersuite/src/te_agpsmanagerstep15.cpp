...
CTe_AgpsManagerStep15::~CTe_AgpsManagerStep15()
	{
	}

CTe_AgpsManagerStep15::CTe_AgpsManagerStep15()
	{
	SetTestStepName(KAgpsManagerStep15);
	}

TVerdict CTe_AgpsManagerStep15::doTestStepPreambleL()
	{
...
//
TVerdict CTe_AgpsManagerStep15::doTestStepL()
	{
 	if (TestStepResult()==EPass)
		...
		// Set H/W Capabilities to Terminal Based AND Terminal Assisted
		...
		//*******************************************************************************************
		//************* LS: Autonomous; NRH: Terminal Assisted + Autonomous  ************************
		//*******************************************************************************************

		// Inject a location request from NRH for method TerminalAssisted+Autonomous (there is an
		// outstanding LS request for autonomous)
		iNrhToManagerRequestInjector->RequestPositionUpdate(CTestAgpsRequestSender::ETPosMethodTaAut);
		// Verify that the Manager sent to the module new GPS options and a location request
		iGpsModuleObserver->WaitForCallBack();
		...
		//*******************************************************************************************
		//************* LS: Autonomous; NRH: Terminal Based + Terminal Assisted *********************
		//*******************************************************************************************
		...
		//*******************************************************************************************
		//************* LS: Terminal Based; NRH: Terminal Assisted + Autonomous  ************************
		//*******************************************************************************************

		// Inject a location request from NRH for method TerminalAssisted+Autonomous (there is an
		// outstanding LS request for Terminal Based)
		iNrhToManagerRequestInjector->RequestPositionUpdate(CTestAgpsRequestSender::ETPosMethodTaAut);
		// Verify that the Manager sent to the module new GPS options and a location request
		iGpsModuleObserver->WaitForCallBack();
		arrayOptions.ClearOptionItems();
		...
		//*******************************************************************************************
		//************* LS: Terminal Based; NRH: Terminal Based + Terminal Assisted *********************
		//*******************************************************************************************
		...
		// Inject a location request from NRH for Autonomous method
		iNrhToManagerRequestInjector->RequestPositionUpdate(CTestAgpsRequestSender::ETPosMethodTa);
		// Verify that the Manager only sent to the module a new location request
		iGpsModuleObserver->WaitForCallBack();
		__ASSERT_ALWAYS(!iGpsModuleObserver->WereGpsOptionsSet(gpsOptions), User::Invariant());
		__ASSERT_ALWAYS(iGpsModuleObserver->WasLocationUpdateRequested(time, quality), User::Invariant());
		...
		//*******************************************************************************************
		//************* LS: Terminal Assisted; NRH: Terminal Assited + Autonomous *****************
		//*******************************************************************************************
		...
		//*******************************************************************************************
		//************* LS: Terminal Assisted; NRH: Terminal Based + Terminal Assisted **************
		//*******************************************************************************************
...
TVerdict CTe_AgpsManagerStep15::doTestStepPostambleL()
	{

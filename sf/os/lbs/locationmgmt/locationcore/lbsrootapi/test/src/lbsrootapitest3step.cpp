...
CLbsRootApiTest3Step::~CLbsRootApiTest3Step()
/**
 * Destructor
 */
	{
 ...
 */
	...
	SetTestStepName(KLbsRootApiTest3Step);
	}

TVerdict CLbsRootApiTest3Step::doTestStepPreambleL()
/**
 * @return - TVerdict code
 * Override of base class virtual
 */
	{
	INFO_PRINTF1(_L("I am in Test Step Preamble in Class CLbsRootApiTest3Step"));
...
__UHEAP_MARK;
    ...
    TInt err;
	TRAP(err,RProperty::Define(KTestLbsPanicRequestKey, 
	                                           RProperty::EInt, 
	                                               KReadPolicy, 
	                                             KWritePolicy));
    if(err != KErrNone)
	...
	TRAP(err,RProperty::Define(KTestLbsPanicOnCloseDownRequestKey, 
	                                           RProperty::EInt, 
	                                               KReadPolicy, 
	                                             KWritePolicy));
    if(err != KErrNone)
...
void CLbsRootApiTest3Step::CheckProcessesAreUp()
	{
	RProcess process;
...
TVerdict CLbsRootApiTest3Step::doTestStepL()
/**
 * @return - TVerdict code
 ...
 */
	...
	if (TestStepResult()==EPass)
		{
		INFO_PRINTF1(_L("CLbsRootApiTest3Step : open RLbsSystemController"));

		iLbsRootProcessApi.OpenL(KLbsTestProcessUid);
        
		INFO_PRINTF1(_L("CLbsRootApiTest3Step : RequestSystemStartup"));
		...
		if(TestStepResult() == EPass)
			{
			INFO_PRINTF1(_L("CLbsRootApiTest3Step : Processes up OK"));    	
			}

		INFO_PRINTF1(_L("CLbsRootApiTest3Step : Panic and immediately request system closeDown from the test harness"));
		iPanicOnCloseDownRequest.Set(1);        
		iLbsRootProcessApi.RequestSystemCloseDown();
		}
	return TestStepResult();
	}

TVerdict CLbsRootApiTest3Step::doTestStepPostambleL()
/**
 * @return - TVerdict code
 * Override of base class virtual
 */
	{
	INFO_PRINTF1(_L("I am in Test Step Postamble in Class CLbsRootApiTest3Step"));

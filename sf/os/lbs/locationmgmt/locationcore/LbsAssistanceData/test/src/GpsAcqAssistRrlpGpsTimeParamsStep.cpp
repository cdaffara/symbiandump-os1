...
/**
 @file GpsAcqAssistRrlpGpsTimeParamsStep.cpp
*/
...
CGpsAcqAssistRrlpGpsTimeParamsStep::~CGpsAcqAssistRrlpGpsTimeParamsStep()
/**
 * Destructor
 */
	{
...
CGpsAcqAssistRrlpGpsTimeParamsStep::CGpsAcqAssistRrlpGpsTimeParamsStep(CTe_LbsAssistanceDataSuite& aOwningServer):
	CTe_LbsAssistanceDataSuiteStepBase(aOwningServer)
	{
	// **MUST** call SetTestStepName in the constructor as the controlling
	// framework uses the test step name immediately following construction to set
	// up the step's unique logging ID.
	SetTestStepName(KGpsAcqAssistRrlpGpsTimeParamsStep);
	}

TVerdict CGpsAcqAssistRrlpGpsTimeParamsStep::doTestStepPreambleL()
/**
 * @return - TVerdict code
 * Override of base class virtual
 */
	{
	// If the field TUEPositioningGpsAcquisitionAssistance::ERrlpGpsReferenceTime doesn't exist,
	// build one
	if (!acquistionAssistanceRootBuilder.FieldExists(TUEPositioningGpsAcquisitionAssistance::ERrlpGpsReferenceTime))
		{
		acquistionAssistanceRootBuilder.GetFieldBuilder(TUEPositioningGpsAcquisitionAssistance::ERrlpGpsReferenceTime, rrlpGpsRefTimeBuilder);
		}
...
TVerdict CGpsAcqAssistRrlpGpsTimeParamsStep::doTestStepL()
/**
 * @return - TVerdict code
 ...
 */
	...
	if (TestStepResult()==EPass)
        ...
        if (!acquistionAssistanceRootReader.FieldExists(TUEPositioningGpsAcquisitionAssistance::ERrlpGpsReferenceTime))
        	{
			...
			err = acquistionAssistanceRootReader.GetFieldReader(TUEPositioningGpsAcquisitionAssistance::ERrlpGpsReferenceTime, rrlpGpsRefTimeReader);
			if(err != KErrNone)
    			{
		...
		//
		acquistionAssistanceRootReader.DataBuffer()=acquistionAssistanceRootBuilder.DataBuffer();
    	exists = acquistionAssistanceRootReader.FieldExists(TUEPositioningGpsAcquisitionAssistance::ERrlpGpsReferenceTime);
    	if(!exists)
			{
...
TVerdict CGpsAcqAssistRrlpGpsTimeParamsStep::doTestStepPostambleL()
/**
 * @return - TVerdict code
 * Override of base class virtual
 */

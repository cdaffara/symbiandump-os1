...
/**
 @file Te_LbsApiVariant2SuiteStepBase.h
 @internalTechnology
*/

#if (!defined __TE_LBSAPIVARIANT2_STEP_BASE__)
#define __TE_LBSAPIVARIANT2_STEP_BASE__
...
* 
****************************************************************************/
class CTe_LbsApiVariant2SuiteStepBase : public CTestStep
	{
public:
	virtual ~CTe_LbsApiVariant2SuiteStepBase();
	CTe_LbsApiVariant2SuiteStepBase();

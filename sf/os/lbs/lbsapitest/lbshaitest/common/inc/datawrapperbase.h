...
public:
	...
	void GetValidationBool(/*CDataWrapperBase* aThis,*/ const TDesC& aSection, TInt aValue, TBool aForceValidation, const TDesC& aErrorMessage);
	void GetValidationInt(/*CDataWrapperBase* aThis,*/ const TDesC& aSection, TInt aValue, TBool aForceValidation, const TDesC& aErrorMessage);
	void GetValidationUint(/*CDataWrapperBase* aThis,*/ const TDesC& aSection, TInt aValue, TBool aForceValidation, const TDesC& aErrorMessage);
	void GetValidationIntArray(/*CDataWrapperBase* aThis,*/ const TDesC& aSection, TInt aValue, TBool aForceValidation, const TDesC& aErrorMessage);

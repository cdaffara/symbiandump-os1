...
#ifndef __RSEnumerateSubModules1_H_
#define __RSEnumerateSubModules1_H_
...
class CRSEnumerateSubModules1Step: public CCapabilityTestStep
	{
public:
...
#endif // __RSEnumerateSubModules1_H_

...
#ifndef __RSCancelUnloadModule1_H_
#define __RSCancelUnloadModule1_H_
...
class CRSCancelUnloadModule1Step: public CCapabilityTestStep
	{
public:
...
#endif // __RSCancelUnloadModule1_H_

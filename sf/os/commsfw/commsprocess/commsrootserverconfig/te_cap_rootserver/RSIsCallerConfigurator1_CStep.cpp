...
*/
CRSIsCallerConfigurator1Step::CRSIsCallerConfigurator1Step()
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CRSCancelLoadModule1Step");

	//The server name and IPC number is obtained and all messages are checked Sync
	SR_ServerName		= _L("!RootServer");
	SR_MESSAGE_TYPE		=	RootServer::RSIsCallerConfigurator;
	SR_MESSAGE_ID		= 2;
...
*/
TInt CRSIsCallerConfigurator1Step::Exec_SendReceive()
	{

...
#ifndef __RSDbgMbufFreeSpace1_H_
#define __RSDbgMbufFreeSpace1_H_
...
class CRSDbgMbufFreeSpace1Step: public CCapabilityTestStep
	{
public:
...
#endif // __RSDbgMbufFreeSpace1_H_

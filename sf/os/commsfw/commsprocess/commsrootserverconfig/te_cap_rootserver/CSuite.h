...
#if (!defined CAP_RootServerPlatSecSuite_SERVER_H_)
#define CAP_RootServerPlatSecSuite_SERVER_H_
...
class  CTestRootServerPlatSecSuiteServer : public CTestServer
{
public:
	static CTestRootServerPlatSecSuiteServer* NewL();

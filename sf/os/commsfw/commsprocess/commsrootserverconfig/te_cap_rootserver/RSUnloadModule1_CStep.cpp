...
CRSUnloadModule1Step::CRSUnloadModule1Step()
	...
	TCapability cap[] = {ECapabilityNetworkControl,ECapabilityPowerMgmt, ECapability_Limit};
...
*/
TInt CRSUnloadModule1Step::Exec_SendReceive()
	{

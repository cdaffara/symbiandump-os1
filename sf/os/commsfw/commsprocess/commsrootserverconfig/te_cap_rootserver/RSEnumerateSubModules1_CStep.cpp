...
*/
CRSEnumerateSubModules1Step::CRSEnumerateSubModules1Step()
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CRSEnumerateSubModules1Step");

	//The server name and IPC number is obtained and all messages are checked Sync
	SR_ServerName		= _L("!RootServer");
	SR_MESSAGE_TYPE		=	2;
	SR_MESSAGE_ID		= RootServer::RSEnumerateSubModules;
...
*/
TInt CRSEnumerateSubModules1Step::Exec_SendReceive()
	{

...
#ifndef __RSEnumerateModules1_H_
#define __RSEnumerateModules1_H_
...
class CRSEnumerateModules1Step: public CCapabilityTestStep
	{
public:
...
#endif // __RSEnumerateModules1_H_

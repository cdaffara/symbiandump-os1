...
#ifndef __RSEnumerateBindings1_H_
#define __RSEnumerateBindings1_H_
...
class CRSEnumerateBindings1Step: public CCapabilityTestStep
	{
public:
...
#endif // __RSEnumerateBindings1_H_

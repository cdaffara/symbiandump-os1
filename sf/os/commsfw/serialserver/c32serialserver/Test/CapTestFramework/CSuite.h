...
const TUint KCommOpenWithEcuart0 = 1000;
const TUint KCommOpenWithEcuart1 = 1001;
const TUint KCommOpenWithEcuart2 = 1002;

const TUint KCommOpenWithDummy0 = 1003;
const TUint KCommOpenWithDummy1 = 1004;
const TUint KCommOpenWithDummy2 = 1005;

const TUint KC32MajorVersionNumber = 0;
const TUint KC32MinorVersionNumber	= 1; 
const TUint KC32BuildVersionNumber = 1;
...
// from CStep.h
	...
	TVerdict GetVerdict(TInt aAPIretValue);
 	...
 	TInt TestDeferCaps(TInt aDeferIPCNo);

...
CDummyMTTests::CDummyMTTests(TThreadData& aTThreadData):CPerformTestTasks(aTThreadData)
	{
	
	}
TInt CDummyMTTests::InitL()
	{
  	_LIT(KCsyName,"Dummy");
	_LIT(KPortName0,"Dummy::6");
	_LIT(KPortName1,"Dummy::0");
...
TInt  CDummyMTTests::PerformTask()
/**
 * @return - TInt
 * This function is used to record the time taken to send 
 * some chunk of data through Dummy CSY. 
*/
	{

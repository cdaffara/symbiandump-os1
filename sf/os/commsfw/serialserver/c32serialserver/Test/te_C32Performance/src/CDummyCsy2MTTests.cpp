...
//
// Description:
// Perform read/write operations through DummyCsy2.
// 
//
...
CDummyCsy2MTTests::CDummyCsy2MTTests(TThreadData& aTThreadData):CPerformTestTasks(aTThreadData)
	{
	
	}
TInt CDummyCsy2MTTests::InitL()
	{
  	_LIT(KCsyName,"DummyCsy2");
	_LIT(KPortName0,"DummyCsy2::6");
	_LIT(KPortName1,"DummyCsy2::0");
...
TInt  CDummyCsy2MTTests::PerformTask()
/**
 * @return - TInt
 * This function is used to record the time taken to send 
 * some chunk of data through DummyCsy2 
*/
	{

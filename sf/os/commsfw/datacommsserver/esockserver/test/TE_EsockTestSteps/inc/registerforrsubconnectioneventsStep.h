...
/**
 @file registerforrsubconnectioneventsStep.h
*/
#if (!defined REGISTERFORRSUBCONNECTIONEVENTS_STEP_H)
#define REGISTERFORRSUBCONNECTIONEVENTS_STEP_H
...
#endif //REGISTERFORRSUBCONNECTIONEVENTS_STEP_H

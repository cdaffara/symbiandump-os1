...
/**
 @file mobilitynotifyrcommsmobilityapiextStep.h
*/
#if (!defined MOBILITYRCOMMSMOBILITYAPIEXT_STEP_H)
#define MOBILITYRCOMMSMOBILITYAPIEXT_STEP_H
#include <testexecutestepbase.h>
#include "Te_EsockStepBase.h"

/**
Class implementing mobilityrcommsmobilityapiext

...
/**
 @file multipleremoversubconnectionStep.h
*/
#if (!defined MULTIPLEREMOVERSUBCONNECTION_STEP_H)
#define MULTIPLEREMOVERSUBCONNECTION_STEP_H
...
#endif //MULTIPLEREMOVERSUBCONNECTION_STEP_H

...
/**
 @file ignorercommsmobilityapiextStep.h
*/
#if (!defined IGNORERCOMMSMOBILITYAPIEXT_STEP_H)
#define IGNORERCOMMSMOBILITYAPIEXT_STEP_H
#include <testexecutestepbase.h>
#include "Te_EsockStepBase.h"

/**
Class implementing ignorercommsmobilityapiext

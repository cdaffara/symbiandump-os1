...
class CZeroCopyLoopbackProviderSelector : public CBase, public ASimpleSelectorBase
...
*/
	{
public:
	explicit CZeroCopyLoopbackProviderSelector(const Meta::SMetaData& aSelectionPreferences)
...
void CZeroCopyLoopbackProviderSelector::SelectL(ISelectionNotify& aSelectionNotify)
	{
...
MProviderSelector* TZeroCopyLoopbackSelectorFactory::NewSelectorL(const Meta::SMetaData& aSelectionPreferences)
	{

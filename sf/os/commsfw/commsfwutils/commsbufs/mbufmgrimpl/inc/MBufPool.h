...
NONSHARABLE_CLASS(CMBufPool) : public CBase
/**
@internalTechnology
*/
	{
...
public:
	~CMBufPool();
	static CMBufPool* New(TInt aMBufSize, TInt aNumMBufs, CMBufPoolChain& aMBufPoolChain, CMBufMemoryAllocator& aMemoryAllocator);
...
//
private:
	friend class CMBufPoolChain;  // for access to iLink

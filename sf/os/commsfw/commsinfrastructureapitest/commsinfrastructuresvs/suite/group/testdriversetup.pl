...
my	$suite="file:/$currentDrive$epoc32Location\\testdriver\\testproduct\\comms-infras.driver#comms-infras";
$suite =~ s.\\./.g;
$suite =~ s\/./\/\g;
...
$cmd .= " --platsec  ON";
$cmd .= " --testexec ON";
$cmd .= " --commdb overwrite=$currentDrive$epoc32Location\\winscw\\c\\comms-infras\\CommDbCommsInfras.xml";
system("$cmd");

...
//
// Description:
// For the Winscw Emulator only, selects between GCE and non-GCE version of Screen Driver.
...
// Progress chaining to the real Scdv is logged in epocwind.out.
// 
//

...
CMMFCodec* CMMFAudioS16PcmU16Codec::NewL(TAny* aInitParams)
	{
	CMMFAudioS16PcmU16Codec* self=new(ELeave) CMMFAudioS16PcmU16Codec();
...
CMMFAudioS16PcmU16Codec::~CMMFAudioS16PcmU16Codec()
	{
	}
...
void CMMFAudioS16PcmU16Codec::ConstructL(TAny* /*aInitParams*/)
	{
	}


//this codec has a does not expand or shrink destination data
TCodecProcessResult CMMFAudioS16PcmU16Codec::ProcessL(const CMMFBuffer& aSrc, CMMFBuffer& aDst)
	{
	...
	iAudioS16ToU16Pcm.Convert(pSrc, pDst, srcUse / 2);

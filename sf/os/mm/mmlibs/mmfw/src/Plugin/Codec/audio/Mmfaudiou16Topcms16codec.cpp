...
CMMFCodec* CMMFAudioU16PcmS16Codec::NewL(TAny* aInitParams)
	{
	CMMFAudioU16PcmS16Codec* self=new(ELeave) CMMFAudioU16PcmS16Codec();
...
CMMFAudioU16PcmS16Codec::~CMMFAudioU16PcmS16Codec()
	{
	}
...
void CMMFAudioU16PcmS16Codec::ConstructL(TAny* /*aInitParams*/)
	{
	}


//this codec has a does not expand or shrink destination data
TCodecProcessResult CMMFAudioU16PcmS16Codec::ProcessL(const CMMFBuffer& aSrc, CMMFBuffer& aDst)
	{
	...
	iAudioU16ToS16Pcm.Convert(pSrc, pDst, srcUse / 2);

...
CMMFCodec* CMMFPcm16AlawCodec::NewL(TAny* aInitParams)
	{
	CMMFPcm16AlawCodec* self=new(ELeave) CMMFPcm16AlawCodec();
...
CMMFPcm16AlawCodec::~CMMFPcm16AlawCodec()
	{
	}
...
void CMMFPcm16AlawCodec::ConstructL(TAny* /*aInitParams*/)
	{
	}

//this codec converts 2 bytes into 1
TCodecProcessResult CMMFPcm16AlawCodec::ProcessL(const CMMFBuffer& aSrc, CMMFBuffer& aDst)
	{
	...
	i16PcmToAlaw.Convert(pSrc, pDst, srcUse / 2);

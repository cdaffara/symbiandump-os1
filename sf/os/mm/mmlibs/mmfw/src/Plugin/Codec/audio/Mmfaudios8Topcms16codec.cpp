...
CMMFCodec* CMMFAudioS8PcmS16Codec::NewL(TAny* aInitParams)
	{
	CMMFAudioS8PcmS16Codec* self=new(ELeave) CMMFAudioS8PcmS16Codec();
...
CMMFAudioS8PcmS16Codec::~CMMFAudioS8PcmS16Codec()
	{
	}
...
void CMMFAudioS8PcmS16Codec::ConstructL(TAny* /*aInitParams*/)
	{
	}


//this codec converts 1 byte to 2 bytes
TCodecProcessResult CMMFAudioS8PcmS16Codec::ProcessL(const CMMFBuffer& aSrc, CMMFBuffer& aDst)
	{

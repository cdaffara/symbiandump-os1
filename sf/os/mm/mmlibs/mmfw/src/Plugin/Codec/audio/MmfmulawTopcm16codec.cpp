...
CMMFCodec* CMMFMulawPcm16Codec::NewL(TAny* aInitParams)
	{
	CMMFMulawPcm16Codec* self=new(ELeave) CMMFMulawPcm16Codec();
...
CMMFMulawPcm16Codec::~CMMFMulawPcm16Codec()
	{
	}
...
void CMMFMulawPcm16Codec::ConstructL(TAny* /*aInitParams*/)
	{
	}


//this codec expands 1 byte to 2 bytes
TCodecProcessResult CMMFMulawPcm16Codec::ProcessL(const CMMFBuffer& aSrc, CMMFBuffer& aDst)
	{
	...
	iMulawTo16Pcm.Convert(pSrc, pDst, srcUse );

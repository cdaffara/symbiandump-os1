...
CMMFCodec* CMMFAudioS16PcmU16BECodec::NewL(TAny* aInitParams)
	{
	CMMFAudioS16PcmU16BECodec* self=new(ELeave) CMMFAudioS16PcmU16BECodec();
...
CMMFAudioS16PcmU16BECodec::~CMMFAudioS16PcmU16BECodec()
	{
	}
...
void CMMFAudioS16PcmU16BECodec::ConstructL(TAny* /*aInitParams*/)
	{
	}


//this codec has a does not expand or shrink destination data
TCodecProcessResult CMMFAudioS16PcmU16BECodec::ProcessL(const CMMFBuffer& aSrc, CMMFBuffer& aDst)
	{
	...
	iAudioS16ToU16BEPcm.Convert(pSrc, pDst, srcUse / 2);

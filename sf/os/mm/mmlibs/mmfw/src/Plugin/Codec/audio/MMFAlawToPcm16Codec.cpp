...
CMMFCodec* CMMFAlawPcm16Codec::NewL(TAny* aInitParams)
	{
	CMMFAlawPcm16Codec* self=new(ELeave) CMMFAlawPcm16Codec();
...
CMMFAlawPcm16Codec::~CMMFAlawPcm16Codec()
	{
	}
...
void CMMFAlawPcm16Codec::ConstructL(TAny* /*aInitParams*/)
	{
	}

//this codec converts 1 byte to 2 bytes
TCodecProcessResult CMMFAlawPcm16Codec::ProcessL(const CMMFBuffer& aSrc, CMMFBuffer& aDst)
	{
	...
	iAlawTo16Pcm.Convert(pSrc, pDst, srcUse );

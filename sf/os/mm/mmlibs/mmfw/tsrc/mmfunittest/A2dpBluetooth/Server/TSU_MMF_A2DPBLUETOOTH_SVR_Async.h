...
#ifndef __TSU_MMF_A2DPBLUETOOTH_SVR_ASYNC_H__
#define __TSU_MMF_A2DPBLUETOOTH_SVR_ASYNC_H__

#include <E32base.h>

class CTestStep_MMF_A2DPBLUETOOTH_SVR; //forward ref

/**
 * This is a utility class used by CTestStep_MMF_A2DPBLUETOOTH_SVR test steps
...
class CAsyncTestStepNotifier : public CActive
	{
public:
	static CAsyncTestStepNotifier* NewL(CTestStep_MMF_A2DPBLUETOOTH_SVR* aTestStep);
...
private:
	CAsyncTestStepNotifier();
	void ConstructL(CTestStep_MMF_A2DPBLUETOOTH_SVR* aTestStep);
private:
	CTestStep_MMF_A2DPBLUETOOTH_SVR* iTestStep;
	};


#endif /* __TSU_MMF_A2DPBLUETOOTH_SVR_ASYNC_H__ */

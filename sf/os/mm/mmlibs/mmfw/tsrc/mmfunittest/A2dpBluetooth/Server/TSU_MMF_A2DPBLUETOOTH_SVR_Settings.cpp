...
CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0100::CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0100()
	{
	iTestStepName = _L("MM-MMF-A2DPBLUETOOTH-SVR-U-0100-HP");
	}
 ...
 */
TVerdict CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0100::DoTestStepL( void )
	{
	TVerdict verdict = EPass;
	RArray<TFourCC> supportedDataTypes;
	TRAP(iError,iA2dpBTHeadsetAudioInterface.GetSupportedDataTypesL(supportedDataTypes));
...
CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0101::CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0101()
	{
	iTestStepName = _L("MM-MMF-A2DPBLUETOOTH-SVR-U-0101-HP");
	}
 ...
 */
TVerdict CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0101::DoTestStepL( void )
	{
	TVerdict verdict = EPass;
	...
	TRAP(iError,iA2dpBTHeadsetAudioInterface.GetSupportedSampleRatesL(supportedDiscreteRates, supportedRateRanges));
...
CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0102::CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0102()
	{
	iTestStepName = _L("MM-MMF-A2DPBLUETOOTH-SVR-U-0102-HP");
	}
 ...
 * stereo is supported.
 */
TVerdict CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0102::DoTestStepL( void )
	{
	TVerdict verdict = EPass;
	...
	//should be KErrNotReady prior to being initialised
	TRAP(iError,iA2dpBTHeadsetAudioInterface.GetSupportedChannelsL(supportedChannels, stereoSupport));
	if (iError != KErrNotReady)
		{
		return EFail;
		} 
...
CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0103::CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0103()
	{
	iTestStepName = _L("MM-MMF-A2DPBLUETOOTH-SVR-U-0103-HP");
	}
 ...
 * @test Req
 */			
TVerdict CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0103::DoTestStepL( void )
	{
	TVerdict verdict = EPass;
...
CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0104::CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0104()
	{
	iTestStepName = _L("MM-MMF-A2DPBLUETOOTH-SVR-U-0104-HP");
	}
 ...
 */			
TVerdict CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0104::DoTestStepL( void )
	{
	TVerdict verdict = EPass;
...
CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0105::CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0105()
	{
	iTestStepName = _L("MM-MMF-A2DPBLUETOOTH-SVR-U-0105-HP");
	}
 ...
 */			
TVerdict CTestStep_MMF_A2DPBLUETOOTH_SVR_U_0105::DoTestStepL( void )
	{
	TVerdict verdict = EPass;

...
#ifndef TS_CMMFDUMMYTESTCONTROLLER_H
#define TS_CMMFDUMMYTESTCONTROLLER_H
...
class CMMFDummyTestController : public CMMFController						   
{
public:
	static CMMFDummyTestController* NewL(void);
	static CMMFDummyTestController* NewLC(void);

...
#ifndef CLISTENERORIENTATIONMESSAGEHANDLER_H
#define CLISTENERORIENTATIONMESSAGEHANDLER_H
...
*  All custom commands send by the ListenerOrientation Proxy are routed to this class. The
*  custom commands are dispatched to the appropriate handler.
*/
class CListenerOrientationMessageHandler: public CMMFObject,
                             public MListenerOrientationObserver
	{
    public:  // Constructors and destructor

        IMPORT_C static CListenerOrientationMessageHandler* NewL( TAny* customInterface );

		/**
		* Destructor.
		*/
		virtual ~CListenerOrientationMessageHandler();
    ...
    public:  // Functions from MListenerOrientationObserver

		/**
		* From MListenerOrientationObserver
	...
	private:
		...
		*/
		CListenerOrientationMessageHandler( CListenerOrientation* aListenerOrientation );
...
#endif      // CLISTENERORIENTATIONMESSAGEHANDLER_H

...
#ifndef CG729DecoderIntfcTestClass_H
#define CG729DecoderIntfcTestClass_H
...
// Logging path
#ifdef __WINSCW__
_LIT( KG729DecoderIntfcTestClassLogPath, "\\logs\\testframework\\" );
#else
_LIT( KG729DecoderIntfcTestClassLogPath, "e:\\testing\\Log\\" );
#endif

// Log file
_LIT( KG729DecoderIntfcTestClassLogFile, "G729DecoderIntfcTestClass.txt" );


// FORWARD DECLARATIONS
class CG729DecoderIntfcTestClass;
...
*  @since Series60_3_2
*/
NONSHARABLE_CLASS(CG729DecoderIntfcTestClass) : public CScriptBase,
    ...
    public:  // Constructors and destructor
        ...
        */
        static CG729DecoderIntfcTestClass* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CG729DecoderIntfcTestClass();

		enum TG729ExpectedEvent
		{
			EInitializeComplete,
			EMaoscOpenComplete,
    ...
    private:
        ...
        */
        CG729DecoderIntfcTestClass( CTestModuleIf& aTestModuleIf );
	    ...
	    * @since ?Series60_version
	    */
	    void AddExpectedEvent(TG729ExpectedEvent event, TInt ms);
	    ...
	    * @since ?Series60_version
	    */
	    TBool RemoveExpectedEvent(TG729ExpectedEvent event);
	    ...
	    * @since ?Series60_version
	    */
	    void ProcessEvent(TG729ExpectedEvent aEvent, TInt aError);
	    ...
	    */
		...
		TInt CreateG729DecoderIntfc( CStifItemParser& aItem );
    ...
    private:    // Data
		...
		CG729DecoderIntfc* iG729Decoder;
		...
		RArray<TG729ExpectedEvent> iExpectedEvents;

		// List of notification event (by the callback)
		RArray<TG729ExpectedEvent> iOcurredEvents;
...
#endif      // CG729DecoderIntfcTestClass_H

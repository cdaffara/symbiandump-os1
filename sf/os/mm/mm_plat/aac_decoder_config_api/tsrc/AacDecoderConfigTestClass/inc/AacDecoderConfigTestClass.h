...
#ifndef CAacDecoderConfigTestClass_H
#define CAacDecoderConfigTestClass_H
...
// Logging path
#ifdef __WINSCW__
_LIT( KAacDecoderConfigTestClassLogPath, "\\logs\\testframework\\" );
#else
_LIT( KAacDecoderConfigTestClassLogPath, "e:\\testing\\Log\\" );
#endif

// Log file
_LIT( KAacDecoderConfigTestClassLogFile, "AacDecoderConfigTestClass.txt" );


// FORWARD DECLARATIONS
class CAacDecoderConfigTestClass;
...
*  @since Series60_3_2
*/
NONSHARABLE_CLASS(CAacDecoderConfigTestClass) : public CScriptBase,
    ...
    public:  // Constructors and destructor
        ...
        */
        static CAacDecoderConfigTestClass* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CAacDecoderConfigTestClass();
    ...
    private:
        ...
        */
        CAacDecoderConfigTestClass( CTestModuleIf& aTestModuleIf );
	    ...
	    */
		...
		TInt CreateAacDecoderConfig( CStifItemParser& aItem );
...
#endif      // CAacDecoderConfigTestClass_H

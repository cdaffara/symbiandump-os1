...
#ifndef CErrorConcealmentIntfcTestClass_H
#define CErrorConcealmentIntfcTestClass_H
...
// Logging path
#ifdef __WINSCW__
_LIT( KErrorConcealmentIntfcTestClassLogPath, "\\logs\\testframework\\" );
#else
_LIT( KErrorConcealmentIntfcTestClassLogPath, "e:\\testing\\Log\\" );
#endif

// Log file
_LIT( KErrorConcealmentIntfcTestClassLogFile, "ErrorConcealmentIntfcTestClass.txt" );


// FORWARD DECLARATIONS
class CErrorConcealmentIntfcTestClass;
...
*  @since Series60_3_2
*/
NONSHARABLE_CLASS(CErrorConcealmentIntfcTestClass) : public CScriptBase,
    ...
    public:  // Constructors and destructor
        ...
        */
        static CErrorConcealmentIntfcTestClass* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CErrorConcealmentIntfcTestClass();
    ...
    private:
        ...
        */
        CErrorConcealmentIntfcTestClass( CTestModuleIf& aTestModuleIf );
	    ...
	    */
		...
		TInt CreateErrorConcealmentIntfc( CStifItemParser& aItem );
    ...
    private:    // Data
		...
		CErrorConcealmentIntfc* iErrorConcealment;
...
#endif      // CErrorConcealmentIntfcTestClass_H

...
#ifndef CEaacPlusDecoderIntfcTestClass_H
#define CEaacPlusDecoderIntfcTestClass_H
...
// Logging path
#ifdef __WINSCW__
_LIT( KEaacPlusDecoderIntfcTestClassLogPath, "\\logs\\testframework\\" );
#else
_LIT( KEaacPlusDecoderIntfcTestClassLogPath, "e:\\testing\\Log\\" );
#endif

// Log file
_LIT( KEaacPlusDecoderIntfcTestClassLogFile, "EaacPlusDecoderIntfcTestClass.txt" );


// FORWARD DECLARATIONS
class CEaacPlusDecoderIntfcTestClass;
...
*  @since Series60_3_2
*/
NONSHARABLE_CLASS(CEaacPlusDecoderIntfcTestClass) : public CScriptBase,
    ...
    public:  // Constructors and destructor
        ...
        */
        static CEaacPlusDecoderIntfcTestClass* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CEaacPlusDecoderIntfcTestClass();

		enum TEaacPlusExpectedEvent
		{
			EInitializeComplete,
			EMaoscOpenComplete,
    ...
    private:
        ...
        */
        CEaacPlusDecoderIntfcTestClass( CTestModuleIf& aTestModuleIf );
	    ...
	    * @since ?Series60_version
	    */
	    void AddExpectedEvent(TEaacPlusExpectedEvent event, TInt ms);
	    ...
	    * @since ?Series60_version
	    */
	    TBool RemoveExpectedEvent(TEaacPlusExpectedEvent event);
	    ...
	    * @since ?Series60_version
	    */
	    void ProcessEvent(TEaacPlusExpectedEvent aEvent, TInt aError);
	    ...
	    */
		...
		TInt CreateEaacPlusDecoderIntfc( CStifItemParser& aItem );
		TInt CreateObject( CStifItemParser& aItem );
		TInt InitObject( CStifItemParser& aItem );

		TInt GetConfigureData( );
		TInt SetConfigureData(  );


  		TInt SetAudioObjectType(  );
		TInt SetInputSamplingFrequency(  );
		TInt SetNumOfChannels(  );
		TInt SetSbr(  );
		TInt SetDownSampledMode( );
		TInt ApplyConfig( );


		TInt GetAudioObjectType(  );
		TInt GetInputSamplingFrequency(  );
		TInt GetNumOfChannels( );
		TInt GetSbr(  );
		TInt GetDownSampledMode(  );
    ...
    private:    // Data
		...
		CEAacPlusDecoderIntfc* iEaacPlusDecoder;
		...
		RArray<TEaacPlusExpectedEvent> iExpectedEvents;

		// List of notification event (by the callback)
		RArray<TEaacPlusExpectedEvent> iOcurredEvents;
...
#endif      // CEaacPlusDecoderIntfcTestClass_H

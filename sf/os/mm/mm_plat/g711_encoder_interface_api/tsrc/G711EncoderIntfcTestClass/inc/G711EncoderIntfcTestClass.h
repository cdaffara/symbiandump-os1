...
#ifndef CG711EncoderIntfcTestClass_H
#define CG711EncoderIntfcTestClass_H
...
// Logging path
#ifdef __WINSCW__
_LIT( KG711EncoderIntfcTestClassLogPath, "\\logs\\testframework\\" );
#else
_LIT( KG711EncoderIntfcTestClassLogPath, "e:\\testing\\Log\\" );
#endif

// Log file
_LIT( KG711EncoderIntfcTestClassLogFile, "G711EncoderIntfcTestClass.txt" );


// FORWARD DECLARATIONS
class CG711EncoderIntfcTestClass;
...
*  @since Series60_3_2
*/
NONSHARABLE_CLASS(CG711EncoderIntfcTestClass) : public CScriptBase,
    ...
    public:  // Constructors and destructor
        ...
        */
        static CG711EncoderIntfcTestClass* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CG711EncoderIntfcTestClass();
    ...
    private:
        ...
        */
        CG711EncoderIntfcTestClass( CTestModuleIf& aTestModuleIf );
	    ...
	    */
		...
		TInt CreateG711EncoderIntfc( CStifItemParser& aItem );
    ...
    private:    // Data
		...
		CG711EncoderIntfc* iG711Encoder;
...
#endif      // CG711EncoderIntfcTestClass_H

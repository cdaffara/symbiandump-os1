...
#ifndef CG729EncoderIntfcTestClass_H
#define CG729EncoderIntfcTestClass_H
...
// Logging path
#ifdef __WINSCW__
_LIT( KG729EncoderIntfcTestClassLogPath, "\\logs\\testframework\\" );
#else
_LIT( KG729EncoderIntfcTestClassLogPath, "e:\\testing\\Log\\" );
#endif

// Log file
_LIT( KG729EncoderIntfcTestClassLogFile, "G729EncoderIntfcTestClass.txt" );


// FORWARD DECLARATIONS
class CG729EncoderIntfcTestClass;
...
*  @since Series60_3_2
*/
NONSHARABLE_CLASS(CG729EncoderIntfcTestClass) : public CScriptBase,
    ...
    public:  // Constructors and destructor
        ...
        */
        static CG729EncoderIntfcTestClass* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CG729EncoderIntfcTestClass();
    ...
    private:
        ...
        */
        CG729EncoderIntfcTestClass( CTestModuleIf& aTestModuleIf );
	    ...
	    */
		...
		TInt CreateG729EncoderIntfc( CStifItemParser& aItem );
    ...
    private:    // Data
		...
		CG729EncoderIntfc* iG729Encoder;
...
#endif      // CG729EncoderIntfcTestClass_H

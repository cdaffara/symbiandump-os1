...
* Contributors:
*
* Description: g729 encoder interface test  G729EncoderIntfcTestClass test module.
*
*/
...
Description: g729 encoder interface test Default constructor
...
Description: g729 encoder interface test Symbian OS second phase constructor
...
Description: g729 encoder interface test Two-phased constructor.
...
Description: g729 encoder interface test Destructor.
...
Description: g729 encoder interface test Start timeout counting
...
Description: g729 encoder interface test RunL handles completed timeouts.
...
Description: g729 encoder interface test Cancel active request
...
Description: g729 encoder interface test Handle errors. Just let framework handle errors because
RunL does not leave.

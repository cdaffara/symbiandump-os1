...
* Contributors:
*
* Description: WmaDecoderIntfcTestClass test module.
*
*/
...
Description: WmaDecoderIntfcTest Default constructor
...
Description: WmaDecoderIntfcTest Symbian OS second phase constructor
...
Description: WmaDecoderIntfcTest Two-phased constructor.
...
Description: WmaDecoderIntfcTest Destructor.
...
Description: WmaDecoderIntfcTest Start timeout counting
...
Description: WmaDecoderIntfcTest RunL handles completed timeouts.
...
Description: WmaDecoderIntfcTest Cancel active request
...
Description: WmaDecoderIntfcTest Handle errors. Just let framework handle errors because
RunL does not leave.

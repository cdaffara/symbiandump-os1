...
#ifndef CIlbcEncoderIntfcTestClass_H
#define CIlbcEncoderIntfcTestClass_H
...
// Logging path
#ifdef __WINSCW__
_LIT( KIlbcEncoderIntfcTestClassLogPath, "\\logs\\testframework\\" );
#else
_LIT( KIlbcEncoderIntfcTestClassLogPath, "e:\\testing\\Log\\" );
#endif

// Log file
_LIT( KIlbcEncoderIntfcTestClassLogFile, "IlbcEncoderIntfcTestClass.txt" );


// FORWARD DECLARATIONS
class CIlbcEncoderIntfcTestClass;
...
*  @since Series60_3_2
*/
NONSHARABLE_CLASS(CIlbcEncoderIntfcTestClass) : public CScriptBase,
    ...
    public:  // Constructors and destructor
        ...
        */
        static CIlbcEncoderIntfcTestClass* NewL( CTestModuleIf& aTestModuleIf );

        /**
        * Destructor.
        */
        virtual ~CIlbcEncoderIntfcTestClass();
    ...
    private:
        ...
        */
        CIlbcEncoderIntfcTestClass( CTestModuleIf& aTestModuleIf );
	    ...
	    */
		...
		TInt CreateIlbcEncoderIntfc( CStifItemParser& aItem );
		TInt CreateIlbcEncoderIntfcNull( CStifItemParser& aItem );
    ...
    private:    // Data
		...
		CIlbcEncoderIntfc* iIlbcEncoder;
...
#endif      // CIlbcEncoderIntfcTestClass_H

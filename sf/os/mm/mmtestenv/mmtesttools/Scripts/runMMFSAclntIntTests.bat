...
rem
rem Description:
rem runMMFAclntIntTests.bat
rem 
rem

del E:\Logs\TestResults\TSI_MMF_ACLNT_SD.htm
del E:\Logs\TestResults\TSI_MMF_ACLNT_SD_NoCap.htm
del E:\Logs\TestResults\TSI_MMF_ACLNT_SD_MMDDCAP.htm
del E:\Logs\TestResults\TSI_MMF_ACLNT_SD_UECAP.htm
del E:\Logs\TestResults\TSI_MMF_ACLNT_SD_PREEMPTION.htm
md E:\Logs\
...
testframework TSI_MMF_ACLNT_SD.script
move c:\Logs\TestResults\*.htm e:\Logs\TestResults\

REM *** Test framework with No capability ***
testframeworknone TSI_MMF_ACLNT_SD_NoCap.script
move c:\Logs\TestResults\*.htm e:\Logs\TestResults\

REM *** Test framework with MultimediaDD capability ***
testframeworkMMDDCap TSI_MMF_ACLNT_SD_MMDDCAP.script
move c:\Logs\TestResults\*.htm e:\Logs\TestResults\

REM *** Test framework with UserEnvironment capability ***
testframeworkUECap TSI_MMF_ACLNT_SD_UECAP.script
move c:\Logs\TestResults\*.htm e:\Logs\TestResults\

testframework TSI_MMF_ACLNT_SD_PREEMPTION.script
move c:\Logs\TestResults\*.htm e:\Logs\TestResults\

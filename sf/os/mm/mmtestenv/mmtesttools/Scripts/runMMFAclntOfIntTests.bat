...
del E:\Logs\TestResults\TSI_MMF_ACLNT_OF.htm
del E:\Logs\TestResults\TSI_MMF_ACLNT_OF_ALLOC.htm
md E:\Logs\
...
testframework TSI_MMF_ACLNT_OF.script
move C:\Logs\TestResults\*.htm E:\Logs\TestResults\

testframework TSI_MMF_ACLNT_OF_ALLOC.script
move C:\Logs\TestResults\*.htm E:\Logs\TestResults\

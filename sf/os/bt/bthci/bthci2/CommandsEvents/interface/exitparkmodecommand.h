...
#ifndef EXITPARKMODECOMMAND_H
#define EXITPARKMODECOMMAND_H
...
class CExitParkModeCommand : public CHCICommandBase
	{
public:
	// Construction
	IMPORT_C static CExitParkModeCommand* NewL(THCIConnectionHandle aConnectionHandle);
	IMPORT_C static CExitParkModeCommand* NewL();
	// Destructor
...
private:
	CExitParkModeCommand(THCIConnectionHandle aConnectionHandle);
	CExitParkModeCommand();

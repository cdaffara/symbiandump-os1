...
#ifndef SWITCHROLECOMMAND_H
#define SWITCHROLECOMMAND_H
...
class CSwitchRoleCommand : public CHCICommandBase
	{
public:
	// Construction
	IMPORT_C static CSwitchRoleCommand* NewL(const TBTDevAddr& aBDADDR, TUint8 aRole);
	IMPORT_C static CSwitchRoleCommand* NewL();
	// Destructor
	~CSwitchRoleCommand();
...
private:
	CSwitchRoleCommand(const TBTDevAddr& aBDADDR, TUint8 aRole);
	CSwitchRoleCommand();

...
EXPORT_C TReadPageTimeoutCompleteEvent::TReadPageTimeoutCompleteEvent(const TDesC8& aEventData)
...
EXPORT_C TReadPageTimeoutCompleteEvent::TReadPageTimeoutCompleteEvent(THCIErrorCode aStatus, TUint8 aNumHCICommandPackets, TUint16 aPageTimeout, TDes8& aEventData)
	: THCICommandCompleteEvent(3 + KCommandCompleteCommonFieldsLength, aNumHCICommandPackets, KReadPageTimeoutOpcode, aEventData)
	{
	iErrorCode = aStatus;
	PutTUint8(aStatus, aEventData);
	PutTUint16(aPageTimeout, aEventData);
...
EXPORT_C TUint16 TReadPageTimeoutCompleteEvent::PageTimeout() const
	{
	return AsTUint16(6);
	}

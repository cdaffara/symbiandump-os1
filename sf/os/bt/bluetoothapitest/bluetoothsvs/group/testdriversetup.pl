...
my	$suite="file:/$currentDrive$epoc32Location\\testdriver\\testproduct\\bluetooth.driver#bluetooth";
$suite =~ s.\\./.g;
$suite =~ s\/./\/\g;
...
$cmd .= " --platsec  ON";
$cmd .= " --testexec ON";
$cmd .= " --commdb overwrite=$currentDrive$epoc32Location\\winscw\\c\\bluetooth\\CommDbWintap.xml";
system("$cmd");

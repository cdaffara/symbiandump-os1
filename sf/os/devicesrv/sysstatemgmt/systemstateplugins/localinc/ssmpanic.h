...
_LIT(KPanicSsmCustCmdRfs, "CSsmCustCmdRfsNotConnected");
_LIT(KPanicCLogicalNot, "CLogicalNot");
_LIT(KPanicCLogicalOr, "CLogicalOr");
_LIT(KPanicCLogicalAnd, "CLogicalAnd");

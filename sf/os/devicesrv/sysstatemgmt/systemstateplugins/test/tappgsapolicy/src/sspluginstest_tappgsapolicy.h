...
#ifndef __SSPLUGINSTEST_TAPPGSAPOLICY_H
#define __SSPLUGINSTEST_TAPPGSAPOLICY_H

#include <s32file.h>
#include <f32file.h>

const TInt KTestAppReboots = 0xA0008E5D;
...
private:
	...
	TBool FrameworkCallsRendezvous();
	};
...
#endif // __SSPLUGINSTEST_TAPPGSAPOLICY_H

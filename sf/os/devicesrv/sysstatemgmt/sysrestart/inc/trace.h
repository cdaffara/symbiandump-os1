...
*
* Description:
* Tracing definitions for the sysrestart project.
*
*/
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[SSMRST]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[SSMRST]: " ##aMsg

...
#ifndef __SSMTESTAPPRVAFTERRETRY_H
#define __SSMTESTAPPRVAFTERRETRY_H

#include <s32file.h>
#include <f32file.h>


const TInt KDontRvCount = 4;
_LIT( KDontRvCountFile, "c:\\dontrvcount.dat" );
...
#endif // __SSMTESTAPPRVAFTERRETRY_H

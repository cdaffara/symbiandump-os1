...
#ifndef __SSMTESTAPPSLOW_H
#define __SSMTESTAPPSLOW_H

const TInt KTestAppMilliToMicro = 1000;
const TInt KTestAppSlowTimeoutInMilliSeconds = 800;
const TInt KTestAppSlowTimeout = KTestAppSlowTimeoutInMilliSeconds * KTestAppMilliToMicro;

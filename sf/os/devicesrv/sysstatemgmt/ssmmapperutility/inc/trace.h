...
*
* Description:
* Tracing definitions for the ssmmapperutility project.
*
*/
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[SSMUTL]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[SSMUTL]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "ssm" );
    _LIT( KFile, "ssmmapperutility.txt" );

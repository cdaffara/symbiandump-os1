...
/**
Old Test CaseID 		APPFWK-SYSSTART-0044
New Test CaseID 		DEVSRVS-SYSSTART-STARTUP-0044
 */


void CAppfwkSysStartTestStepAppStartNc::TestAppStartNcL()
	{
...
/**
   Destructor
 */
CAppfwkSysStartTestStepAppStartNc::~CAppfwkSysStartTestStepAppStartNc()
	{
	}
...
CAppfwkSysStartTestStepAppStartNc::CAppfwkSysStartTestStepAppStartNc()
	...
	SetTestStepName(KCAppfwkSysStartTestStepAppStartNc);
	}
 ...
 */
TVerdict CAppfwkSysStartTestStepAppStartNc::doTestStepL()
	{
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0044: AppStartNc - Started"));
	...
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0044: AppStartNc - Finished"));

...
/**
Old Test CaseID 		APPFWK-SYSSTART-0042
New Test CaseID 		DEVSRVS-SYSSTART-STARTUP-0042
 */


void CAppfwkSysStartTestStepAppStartCs::TestAppStartCsL()
	{
...
/**
   Destructor
 */
CAppfwkSysStartTestStepAppStartCs::~CAppfwkSysStartTestStepAppStartCs()
	{
	}
...
CAppfwkSysStartTestStepAppStartCs::CAppfwkSysStartTestStepAppStartCs()
	...
	SetTestStepName(KCAppfwkSysStartTestStepAppStartCs);
	}
 ...
 */
TVerdict CAppfwkSysStartTestStepAppStartCs::doTestStepL()
	{
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0042: AppStartCs - Started"));
	...
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0042: AppStartCs - Finished"));

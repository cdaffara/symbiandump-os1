...
/**
Old Test CaseID 		APPFWK-SYSSTART-0035
New Test CaseID 		DEVSRVS-SYSSTART-STARTUP-0035
 */


void CAppfwkSysStartTestStepProcStartNc::TestProcStartNcL()
	{
...
/**
   Destructor
 */
CAppfwkSysStartTestStepProcStartNc::~CAppfwkSysStartTestStepProcStartNc()
	{
	}
...
CAppfwkSysStartTestStepProcStartNc::CAppfwkSysStartTestStepProcStartNc()
	...
	SetTestStepName(KCAppfwkSysStartTestStepProcStartNc);
	}
 ...
 */
TVerdict CAppfwkSysStartTestStepProcStartNc::doTestStepL()
	{
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0035: ProcStartNc - Started"));
	...
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0035: ProcStartNc - Finished"));

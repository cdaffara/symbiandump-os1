...
/**
Old Test CaseID 		APPFWK-SYSSTART-0070
New Test CaseID 		DEVSRVS-SYSSTART-STARTUP-0070
 */


void CAppfwkSysStartTestStepDefInvalidProcRetry::TestDefInvalidProcRetryL()
	{
...
/**
   Destructor
 */
CAppfwkSysStartTestStepDefInvalidProcRetry::~CAppfwkSysStartTestStepDefInvalidProcRetry()
	{
	}
...
CAppfwkSysStartTestStepDefInvalidProcRetry::CAppfwkSysStartTestStepDefInvalidProcRetry()
	...
	SetTestStepName(KCAppfwkSysStartTestStepDefInvalidProcRetry);
	}
 ...
 */
TVerdict CAppfwkSysStartTestStepDefInvalidProcRetry::doTestStepL()
	{
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0070: DefInvalidProcRetry - Started"));

 	__UHEAP_MARK;
 	
	TestDefInvalidProcRetryL();

	__UHEAP_MARKEND;

	INFO_PRINTF1(_L("APPFWK-SYSSTART-0070: DefInvalidProcRetry - Finished"));

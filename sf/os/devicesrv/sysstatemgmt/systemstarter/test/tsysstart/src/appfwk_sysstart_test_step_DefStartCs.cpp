...
/**
Old Test CaseID 		APPFWK-SYSSTART-0052
New Test CaseID 		DEVSRVS-SYSSTART-STARTUP-0052
 */


void CAppfwkSysStartTestStepDefStartCs::TestDefStartCsL()
	{
...
/**
   Destructor
 */
CAppfwkSysStartTestStepDefStartCs::~CAppfwkSysStartTestStepDefStartCs()
	{
	}
...
CAppfwkSysStartTestStepDefStartCs::CAppfwkSysStartTestStepDefStartCs()
	...
	SetTestStepName(KCAppfwkSysStartTestStepDefStartCs);
	}
 ...
 */
TVerdict CAppfwkSysStartTestStepDefStartCs::doTestStepL()
	{
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0052: DefStartCs - Started"));
	...
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0052: DefStartCs - Finished"));

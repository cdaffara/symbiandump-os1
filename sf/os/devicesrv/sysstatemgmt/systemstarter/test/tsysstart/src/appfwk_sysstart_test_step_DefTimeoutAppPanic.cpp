...
/**
Old Test CaseID 		APPFWK-SYSSTART-0063
New Test CaseID 		DEVSRVS-SYSSTART-STARTUP-0063
 */


void CAppfwkSysStartTestStepDefTimeoutAppPanic::TestDefTimeoutAppPanicL()
	{
...
/**
   Destructor
 */
CAppfwkSysStartTestStepDefTimeoutAppPanic::~CAppfwkSysStartTestStepDefTimeoutAppPanic()
	{
	}
...
CAppfwkSysStartTestStepDefTimeoutAppPanic::CAppfwkSysStartTestStepDefTimeoutAppPanic()
	...
	SetTestStepName(KCAppfwkSysStartTestStepDefTimeoutAppPanic);
	}
 ...
 */
TVerdict CAppfwkSysStartTestStepDefTimeoutAppPanic::doTestStepL()
	{
	INFO_PRINTF1(_L("APPFWK-SYSSTART-0063: DefTimeoutAppPanic - Started"));

 	__UHEAP_MARK;
 	
	TestDefTimeoutAppPanicL();

	__UHEAP_MARKEND;

	INFO_PRINTF1(_L("APPFWK-SYSSTART-0063: DefTimeoutAppPanic - Finished"));

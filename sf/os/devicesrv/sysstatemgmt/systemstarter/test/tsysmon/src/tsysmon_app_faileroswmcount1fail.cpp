...
TInt MainL()
	{
	RDebug::Print(_L("appfwk-sysmon-0036: MainL"));
	...
	RDebug::Print(_L("appfwk-sysmon-0036: End MainL"));
	return KErrNone;
	}
...
GLDEF_C TInt E32Main()
	...
	RDebug::Print(_L("appfwk-sysmon-0036: E32Main"));
	__UHEAP_MARK;
	...
	delete cleanup;
	__UHEAP_MARKEND;
	RDebug::Print(_L("appfwk-sysmon-0036: End E32Main"));
	return KErrNone;
	}

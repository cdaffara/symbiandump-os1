...
*
* Description:
* Tracing definitions for the ssmcustcmds project.
*
*/
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[SSMCCS]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[SSMCCS]: " ##aMsg

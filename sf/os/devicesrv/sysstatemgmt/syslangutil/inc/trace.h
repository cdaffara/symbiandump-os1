...
*
* Description:
* Tracing definitions for the syslangutil project.
*
*/
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[SSMSLU]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[SSMSLU]: " ##aMsg

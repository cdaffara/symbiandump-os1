...
*
* Description:
* Tracing definitions for the sysuiprovider project.
*
*/
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[SSMUIP]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[SSMUIP]: " ##aMsg

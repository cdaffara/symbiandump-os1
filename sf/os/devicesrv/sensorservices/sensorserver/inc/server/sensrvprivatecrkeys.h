...
/**
* Specifies the time in seconds for starting sensor server auto shutdown 
* sequence when there are no sessions open and SSYs loaded.
*
* Value is an integer.
*
* Default value: 30
*/
const TUint32 KSensrvTerminationPeriodKey = 0x00000007;
...
/**
* Sensor server channel groups API
*
* Contains channel group settings.
*/
const TUid KCRUidSensorServerChannelGroups = {0x2001CB75};

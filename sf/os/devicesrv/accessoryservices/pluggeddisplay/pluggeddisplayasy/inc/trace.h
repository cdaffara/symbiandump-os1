...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[PDAsy]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[PDAsy]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "PDAsy" );
    _LIT( KFile, "PDAsy_log.txt" );
    _LIT( KFullPath, "c:\\logs\\PDAsy\\" );

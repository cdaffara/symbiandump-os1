...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[PDEngine]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[PDEngine]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "PDEngine" );
    _LIT( KFile, "PDEngine_log.txt" );
    _LIT( KFullPath, "c:\\logs\\PDEngine\\" );

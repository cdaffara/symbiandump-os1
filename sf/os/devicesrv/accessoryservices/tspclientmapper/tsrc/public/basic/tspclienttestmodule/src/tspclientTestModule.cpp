...
// -----------------------------------------------------------------------------
//
CTspClientTestModule::CTspClientTestModule()
    {
	}
...
// -----------------------------------------------------------------------------
//
void CTspClientTestModule::ConstructL()
    {
...
// -----------------------------------------------------------------------------
//
CTspClientTestModule* CTspClientTestModule::NewL()
    {
    CTspClientTestModule* self = new (ELeave) CTspClientTestModule();
...
// -----------------------------------------------------------------------------
//
TInt CTspClientTestModule::InitL( 
    TFileName& /*aIniFile*/, 
    TBool /*aFirstTime*/ )
    {
...
// -----------------------------------------------------------------------------
//
TInt CTspClientTestModule::GetTestCasesL( 
...
// -----------------------------------------------------------------------------
//
TInt CTspClientTestModule::RunTestCaseL( 
...
// -----------------------------------------------------------------------------
//
TBool CTspClientTestModule::OOMTestQueryL( 
...
// -----------------------------------------------------------------------------
//
void CTspClientTestModule::OOMTestResetL( 
                                const TFileName& /* aTestCaseFile */, 
                                const TInt /* aCaseNumber */ )
    {
    }
...
// -----------------------------------------------------------------------------
//
void CTspClientTestModule::OOMHandleWarningL( 
                                const TFileName& /* aTestCaseFile */,
                                const TInt /* aCaseNumber */, 
                                TInt& /* aFailNextValue */ )
    {
...
// -----------------------------------------------------------------------------
//
void CTspClientTestModule::OOMTestFinalizeL( 
                                const TFileName& /* aTestCaseFile */, 
                                const TInt /* aCaseNumber */ )
    {
    }
...
EXPORT_C CTestModuleBase* LibEntryL()
    {
    return CTspClientTestModule::NewL();

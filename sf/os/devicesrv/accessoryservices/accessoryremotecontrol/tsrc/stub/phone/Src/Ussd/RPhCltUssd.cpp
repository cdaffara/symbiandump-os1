...
// -----------------------------------------------------------------------------
//
EXPORT_C RPhCltUssd::RPhCltUssd()
    : RSubSessionBase()
    {
    }
...
// -----------------------------------------------------------------------------
//
EXPORT_C TInt RPhCltUssd::Open( RPhCltServer& aServer )
    {
...
// -----------------------------------------------------------------------------
//
EXPORT_C void RPhCltUssd::Close()
    {    
...
// ---------------------------------------------------------------------------
//
EXPORT_C TInt RPhCltUssd::StartUssdEditor() const
    {
    return SendReceive(
...
// -----------------------------------------------------------------------------
//
EXPORT_C TInt RPhCltUssd::AppStarting()
    {
    return SendReceive(
...
// -----------------------------------------------------------------------------
//
EXPORT_C TInt RPhCltUssd::AppTerminating( 
...
// -----------------------------------------------------------------------------
//
EXPORT_C TBool RPhCltUssd::AppToForeground()
    {
...
// -----------------------------------------------------------------------------
//
EXPORT_C TInt RPhCltUssd::AppToBackground()
    {
    return SendReceive(
...
// -----------------------------------------------------------------------------
//
EXPORT_C void RPhCltUssd::SendUssd( 
...
// -----------------------------------------------------------------------------
//
EXPORT_C void RPhCltUssd::CancelSend()
    {
    SendReceive(

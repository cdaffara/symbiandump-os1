...
TInt MainL()
	{
	RDebug::Print(_L("appfwk-sysmon-0035: MainL"));
	...
	RDebug::Print(_L("appfwk-sysmon-0035: End MainL"));
	return KErrNone;
	}
...
GLDEF_C TInt E32Main()
	...
	RDebug::Print(_L("appfwk-sysmon-0035: E32Main"));
	__UHEAP_MARK;
	...
	delete cleanup;
	__UHEAP_MARKEND;
	RDebug::Print(_L("appfwk-sysmon-0035: End E32Main"));
	return KErrNone;

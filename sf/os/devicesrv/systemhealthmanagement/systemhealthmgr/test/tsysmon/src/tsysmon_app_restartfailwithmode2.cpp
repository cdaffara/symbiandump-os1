...
LOCAL_C TInt MainL()
    ...
    switch (runCount)
        ...
        case 0: 
			...
			CStartupProperties* props2 = CStartupProperties::NewLC(KFilenameDeregTimeout, args);
			props2->SetMonitored(ETrue);
			props2->SetStartupType(EStartProcess);
			props2->SetStartMethod(EWaitForStart);
			props2->SetNoOfRetries(1);
			props2->SetTimeout(0);
			props2->SetRecoveryParams(ERestartOSWithMode, 1);
			...
			RProcess slave2;
			slave2.Create(KFilenameDeregTimeout, args);

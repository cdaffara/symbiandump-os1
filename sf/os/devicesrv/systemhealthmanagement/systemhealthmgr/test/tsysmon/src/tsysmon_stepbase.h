...
protected:
	...
	void MonitorL(const RProcess& aProcess, const CSsmStartupProperties& aProp);
	void StartAndMonitorUsingStartupPropL(RProcess& aProcess, TStartMethod aStartMethod);
	void StartAndMonitorUsingSsmStartupPropL(RProcess& aProcess, TStartMethod aStartMethod);

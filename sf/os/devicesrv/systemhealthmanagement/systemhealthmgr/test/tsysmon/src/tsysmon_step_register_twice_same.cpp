...
CRegisterTwiceSameStep::~CRegisterTwiceSameStep()
	{
	}

CRegisterTwiceSameStep::CRegisterTwiceSameStep()
	{
	SetTestStepName(KRegisterTwiceSameStep);
	}

TVerdict CRegisterTwiceSameStep::doTestStepL()
	{
	...
	User::LeaveIfError(slave.Create(KFilenameRegisterTwice1, args));
	slave.Resume();

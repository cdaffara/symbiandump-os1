...
CHWRMFmTxClearRdsDataStep::CHWRMFmTxClearRdsDataStep()
...
*/
	...
	SR_MESSAGE_ID		= EHWRMFmTxClearRdsData ;	//It holds the IPC number
...
TInt CHWRMFmTxClearRdsDataStep::Exec_SendReceive()
	{

...
CHWRMFmTxSetRadiotextStep::CHWRMFmTxSetRadiotextStep()
...
*/
	...
	SR_MESSAGE_ID		= EHWRMFmTxSetRadiotext ;	//It holds the IPC number
...
TInt CHWRMFmTxSetRadiotextStep::Exec_SendReceive()
	{

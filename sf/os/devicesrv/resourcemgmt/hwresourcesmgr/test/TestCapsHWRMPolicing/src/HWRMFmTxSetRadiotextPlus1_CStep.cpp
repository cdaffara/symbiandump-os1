...
CHWRMFmTxSetRadiotextPlus1Step::CHWRMFmTxSetRadiotextPlus1Step()
...
*/
	...
	SR_MESSAGE_ID		= EHWRMFmTxSetRadiotextPlus1 ;	//It holds the IPC number
...
TInt CHWRMFmTxSetRadiotextPlus1Step::Exec_SendReceive()
	{

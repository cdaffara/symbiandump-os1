...
CHWRMFmTxSetNextClearFreqStep::CHWRMFmTxSetNextClearFreqStep()
...
*/
	...
	TUint32 KCapabilityCapabilityMultimediaDDBitMask  = 0x8; //8LL;
	...
	SR_MESSAGE_ID		= EHWRMFmTxSetNextClearFreq ;	//It holds the IPC number
	SR_MESSAGE_MASK		= KCapabilityCapabilityMultimediaDDBitMask; //Holds the cap mask for the message
	...
	TCapability cap[] = {ECapabilityMultimediaDD, ECapability_Limit};
	...
	iStepCap            = KCapabilityCapabilityMultimediaDDBitMask;
...
TInt CHWRMFmTxSetNextClearFreqStep::Exec_SendReceive()
	{

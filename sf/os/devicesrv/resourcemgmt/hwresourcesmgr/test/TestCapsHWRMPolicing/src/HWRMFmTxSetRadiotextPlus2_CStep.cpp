...
CHWRMFmTxSetRadiotextPlus2Step::CHWRMFmTxSetRadiotextPlus2Step()
...
*/
	...
	SR_MESSAGE_ID		= EHWRMFmTxSetRadiotextPlus2 ;	//It holds the IPC number
...
TInt CHWRMFmTxSetRadiotextPlus2Step::Exec_SendReceive()
	{

...
CHWRMFmTxGetNextClearFreqArrayStep::CHWRMFmTxGetNextClearFreqArrayStep()
...
*/
	...
	SR_MESSAGE_ID		= EHWRMFmTxGetNextClearFreqArray ;	//It holds the IPC number
...
TInt CHWRMFmTxGetNextClearFreqArrayStep::Exec_SendReceive()
	{

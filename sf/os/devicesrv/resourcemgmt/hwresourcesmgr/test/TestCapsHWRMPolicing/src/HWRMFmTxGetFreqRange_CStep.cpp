...
CHWRMFmTxGetFreqRangeStep::CHWRMFmTxGetFreqRangeStep()
...
*/
	...
	SR_MESSAGE_ID		= EHWRMFmTxGetFreqRange ;	//It holds the IPC number
...
TInt CHWRMFmTxGetFreqRangeStep::Exec_SendReceive()
	{

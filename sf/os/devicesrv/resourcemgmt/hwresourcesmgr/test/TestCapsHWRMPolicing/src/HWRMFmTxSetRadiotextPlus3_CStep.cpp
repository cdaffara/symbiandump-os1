...
CHWRMFmTxSetRadiotextPlus3Step::CHWRMFmTxSetRadiotextPlus3Step()
...
*/
	...
	SR_MESSAGE_ID		= EHWRMFmTxSetRadiotextPlus3 ;	//It holds the IPC number
...
TInt CHWRMFmTxSetRadiotextPlus3Step::Exec_SendReceive()
	{

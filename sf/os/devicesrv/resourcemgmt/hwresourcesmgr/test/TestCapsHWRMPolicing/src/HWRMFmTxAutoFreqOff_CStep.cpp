...
CHWRMFmTxAutoFreqOffStep::CHWRMFmTxAutoFreqOffStep()
...
*/
	...
	const TUint32 KCapabilityNoneBitMask  = 0x80000000; // 2147483648LL;
	...
	SR_MESSAGE_ID		= EHWRMFmTxAutoFreqOff ;	//It holds the IPC number
...
TInt CHWRMFmTxAutoFreqOffStep::Exec_SendReceive()
	{

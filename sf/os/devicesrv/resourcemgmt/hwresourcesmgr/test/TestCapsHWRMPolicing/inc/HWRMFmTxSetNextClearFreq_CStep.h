...
#ifndef HWRMFMTXSETNEXTCLEARFREQ_CSTEP_H_
#define HWRMFMTXSETNEXTCLEARFREQ_CSTEP_H_
...
class CHWRMFmTxSetNextClearFreqStep: public CCapabilityTestStep
	{
...
#endif /*HWRMFMTXSETNEXTCLEARFREQ_CSTEP_H_*/

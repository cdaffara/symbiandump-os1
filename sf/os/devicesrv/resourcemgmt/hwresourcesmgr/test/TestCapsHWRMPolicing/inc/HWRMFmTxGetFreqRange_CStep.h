...
#ifndef HWRMFMTXGETFREQRANGE_CSTEP_H_
#define HWRMFMTXGETFREQRANGE_CSTEP_H_
...
class CHWRMFmTxGetFreqRangeStep: public CCapabilityTestStep
	{
...
#endif /*HWRMFMTXGETFREQRANGE_CSTEP_H_*/

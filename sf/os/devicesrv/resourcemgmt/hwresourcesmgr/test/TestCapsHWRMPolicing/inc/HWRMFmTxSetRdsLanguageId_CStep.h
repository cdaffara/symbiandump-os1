...
#ifndef HWRMFMTXSETRDSLANGUAGEID_CSTEP_H_
#define HWRMFMTXSETRDSLANGUAGEID_CSTEP_H_
...
class CHWRMFmTxSetRdsLanguageIdStep: public CCapabilityTestStep
	{
...
#endif /*HWRMFMTXSETRDSLANGUAGEID_CSTEP_H_*/

...
#ifndef HWRMFMTXCLEARRDSDATA_CSTEP_H_
#define HWRMFMTXCLEARRDSDATA_CSTEP_H_
...
class CHWRMFmTxClearRdsDataStep: public CCapabilityTestStep
	{
...
#endif /*HWRMFMTXCLEARRDSDATA_CSTEP_H_*/

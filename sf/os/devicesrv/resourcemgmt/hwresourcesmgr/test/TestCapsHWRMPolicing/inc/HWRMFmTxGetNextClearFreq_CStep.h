...
#ifndef HWRMFMTXGETNEXTCLEARFREQ_CSTEP_H_
#define HWRMFMTXGETNEXTCLEARFREQ_CSTEP_H_
...
class CHWRMFmTxGetNextClearFreqStep: public CCapabilityTestStep
	{
...
#endif /*HWRMFMTXGETNEXTCLEARFREQ_CSTEP_H_*/

...
#ifndef HWRMFMTXSETRDSPTYN_CSTEP_H_
#define HWRMFMTXSETRDSPTYN_CSTEP_H_
...
class CHWRMFmTxSetRdsPtynStep: public CCapabilityTestStep
	{
...
#endif /*HWRMFMTXSETRDSPTYN_CSTEP_H_*/

...
#ifndef HWRMFMTXSETRDSPTY_CSTEP_H_
#define HWRMFMTXSETRDSPTY_CSTEP_H_
...
class CHWRMFmTxSetRdsPtyStep: public CCapabilityTestStep
	{
...
#endif /*HWRMFMTXSETRDSPTY_CSTEP_H_*/

...
//
// Description:
// This contains CTestHWRM_API_PolicingSuite 
// 
//

#if (!defined CAP_HWRM_API_POLICING_SERVER_H_)
#define CAP_HWRM_API_POLICING_SERVER_H_
...
const TInt  KAsyncMessage                       = 1;
const TInt  KSyncMessage                        = 2;
...
class  CTestHWRM_API_PolicingServer : public CTestServer
{
public:
	static CTestHWRM_API_PolicingServer	* NewL();

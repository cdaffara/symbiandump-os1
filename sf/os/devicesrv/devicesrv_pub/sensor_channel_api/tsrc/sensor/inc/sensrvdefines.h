...
* CSensorChannel.iMaxBufferingCount is set to channel data rate
...
* Buffer lenght is set to CSensorChannel.iMaxBufferingCount times this.
...
/**
* CSensorChannel.iMaxBufferingCount will be set to this if it cannot be 
* calculated.
*/

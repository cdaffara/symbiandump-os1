...
#ifndef COMMONDSY_DEBUG_H
#define COMMONDSY_DEBUG_H
...
// CONSTANTS
_LIT( KComponent, "[COMMONDSY:Component]" );
_LIT( KThisFile,  "[COMMONDSY:Component] - Trace this file: %s, line: %d, compiled: %s %s" );
_LIT( KAssertion, "[COMMONDSY:Component] - Assertion failed: File: %s, line: %d, compiled: %s %s" );
_LIT( KPanic,     "[COMMONDSY:Component] - Panic occurred: File: %s, line: %d, compiled: %s %s" );
_LIT( KMystic,    "[COMMONDSY:Component] - Mystic failure: File: %s, line: %d, compiled: %s %s" );
